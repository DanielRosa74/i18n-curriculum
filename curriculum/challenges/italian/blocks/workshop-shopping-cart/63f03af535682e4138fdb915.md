...
Imposta il `textContent` dell'elemento `totalNumberOfItems` su `0` e il `textContent` degli elementi `cartSubTotal`, `cartTaxes` e `cartTotal` su `"$0"`.
...
Devi impostare il `textContent` dell'elemento `cartSubTotal` su `"$0"`.
...
Devi impostare il `textContent` dell'elemento `cartTaxes` su `"$0"`.
...
Devi impostare il `textContent` dell'elemento `cartTotal` su `"$0"`.
