...
Debes declarar una variable `const` llamada `header` con el valor `"Title,Author,Year,Location"`.
...
Debes declarar una variable `const` llamada `rows` asignada a un arreglo vacío.
