...
Oltre alla prima opzione vuota, l'elemento `select` dovrebbe contenere 6 elementi `option`, uno per ciascuna delle seguenti città: Parigi, Londra, Tokyo, Los Angeles, Chicago, New York.
