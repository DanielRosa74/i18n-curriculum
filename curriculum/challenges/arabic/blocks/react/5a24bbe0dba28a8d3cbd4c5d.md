...
كان التحدي الأخير مثالًا بسيطًا على JSX، لكن يمكن لـ JSX تمثيل HTML أكثر تعقيدًا أيضًا.
...
**ملاحظة:** عند عرض عدة عناصر مثل هذه، يمكنك تغليفها جميعًا داخل أقواس عادية، لكن هذا ليس مطلوبًا بالضرورة. لاحظ أيضًا أن هذا التحدي يستخدم وسم `div` لتغليف جميع العناصر الفرعية داخل عنصر أب واحد. إذا أزلت `div`، فلن يُحوّل JSX بعد ذلك. احتفظ بهذا في ذهنك، إذ سيطبق الأمر نفسه عند إرجاع عناصر JSX في مكوّنات React.
