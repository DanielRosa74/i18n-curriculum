...
Вам потрібен ще один такий блок коду `fieldset` для `entertainment`.
...
Ваш четвертий `fieldset` елемент повинен мати `id`, встановлений на `entertainment`.
...
Ваш четвертий `legend` елемент повинен містити текст `Entertainment`.
