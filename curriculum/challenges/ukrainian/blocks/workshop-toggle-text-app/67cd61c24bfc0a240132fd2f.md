...
Текст вашої кнопки має показувати `Show Message`, коли `isVisible` дорівнює `false`.
...
Текст вашої кнопки має показувати `Hide Message`, коли `isVisible` дорівнює `true`.
