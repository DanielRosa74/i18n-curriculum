...
Um arquivo MP3 tem o tipo MIME `audio/mpeg`. Um MP4, no entanto, pode ter o tipo MIME `audio/mp4` OU `video/mp4`, dependendo se é um arquivo de vídeo ou apenas áudio. Essa distinção indica ao navegador como lidar com o arquivo.
