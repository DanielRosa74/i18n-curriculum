...
Los ciclos se usan para repetir un bloque de código. En esta lección, aprenderás a trabajar con diferentes tipos de ciclos en Python.
...
Puedes anidar ciclos `for` en Python. Aquí tienes un ejemplo de un ciclo `for` anidado:
...
Revisa la lección para identificar qué ciclo de Python se repite hasta que una condición es `False`.
