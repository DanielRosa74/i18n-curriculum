...
JavaScript executa seu código de cima para baixo. Quando JavaScript executa seu código e encontra uma declaração `debugger`, ele pausa imediatamente a execução naquela linha. Isso te dá a chance de inspecionar variáveis, verificar funções e o fluxo do código em geral.
