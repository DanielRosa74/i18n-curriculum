...
Тепер створіть `p` елемент із текстом `$${income} Total Income`, використовуючи інтерполяцію, щоб замінити income на відповідну змінну.
...
Ваш `p` елемент має містити текст `$${income} Total Income`.
