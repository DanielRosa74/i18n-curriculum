...
Declare uma variável `regex` e atribua a ela o valor do exemplo acima. Nos próximos passos, você vai atualizar esse padrão regex para corresponder a caracteres específicos necessários para o planejador de orçamento por envelope.
