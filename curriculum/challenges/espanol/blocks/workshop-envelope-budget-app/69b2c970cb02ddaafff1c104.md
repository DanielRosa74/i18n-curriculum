...
Tu siguiente paso es permitir que los usuarios agreguen entradas al presupuesto por sobres. Declara una función vacía `addEntry`. Esta función no debe recibir ningún parámetro.
