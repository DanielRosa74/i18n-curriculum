...
- Jedes Tor hat ein `queue` Array, das zeigt, wie viele Teilnehmer bei jedem Tick ankommen.
- Da alle Tore die gleiche Anzahl an Ticks haben, können Sie einfach die Länge des `queue` Arrays des ersten Tors verwenden.
