...
title: Renderizar un componente de clase en el DOM
challengeType: 6
forumTopicId: 301404
...
Los componentes de React se pasan a `ReactDOM.render()` de manera un poco diferente que los elementos JSX. Para los elementos JSX, pasas el nombre del elemento que quieres renderizar. Sin embargo, para los componentes de React, necesitas usar la misma sintaxis que si estuvieras renderizando un componente anidado, por ejemplo `ReactDOM.render(<ComponentToRender />, targetNode)`. Usas esta sintaxis tanto para componentes de clase ES6 como para componentes funcionales.
