...
في الوقت الحالي، لا تحتوي `parseCard` على جسم، لذا تُرجع `undefined`. مع إضافة كود إلى الدالة خلال الخطوات التالية، سيُظهر الإخراج المسجل بالضبط ما تُرجعه الدالة في كل مرحلة.
