...
Ogni elemento avrà un input di testo per il nome dell'elemento e un input numerico per il budget. Per ottenere il conteggio del numero di elementi, puoi fare una query sugli input di testo.
