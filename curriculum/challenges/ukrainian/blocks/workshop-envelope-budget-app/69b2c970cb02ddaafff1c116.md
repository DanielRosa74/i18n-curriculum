...
У своїй новій функції оголосіть змінну `total` і призначте їй значення `0`. Використовуйте `let` для оголошення, оскільки пізніше ви будете переназначати її.

# --hints--

Ви повинні оголосити змінну `total`.
...
Вашій змінній `total` має бути призначене значення `0`.
...
Ви повинні оголосити змінну `total` за допомогою `let`.
