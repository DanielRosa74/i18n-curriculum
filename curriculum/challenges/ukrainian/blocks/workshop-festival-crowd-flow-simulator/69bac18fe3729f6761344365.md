...
- Кожні ворота мають масив `queue`, який показує, скільки відвідувачів приходить на кожну поділку.
- Оскільки всі ворота мають однакову кількість поділок, ви можете просто використати довжину масиву `queue` перших воріт.
