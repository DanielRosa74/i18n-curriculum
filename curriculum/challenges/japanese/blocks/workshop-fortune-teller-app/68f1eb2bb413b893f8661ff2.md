...
`newReading` メソッドの中で、`showElements` を呼び出し、`this.elements.singleCardBtn`、`this.elements.multipleCardsBtn`、および `this.elements.headerTitle` を引数として渡してください。

次に、`hideElements` を呼び出し、`this.elements.singleCard`、`this.elements.multipleCard`、`this.elements.fortuneContainer`、および `this.elements.fortuneDescription` を引数として渡してください。
