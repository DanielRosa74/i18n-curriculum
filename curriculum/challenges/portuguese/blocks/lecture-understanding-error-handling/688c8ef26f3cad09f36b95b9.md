...
1. Pressione <kbd>F5</kbd> ou vá em Executar > Iniciar depuração
...
- **Continuar (<kbd>F5</kbd>)**: Retomar a execução até o próximo ponto de interrupção

- **Passar por cima (<kbd>F10</kbd>)**: Executar a linha atual e passar para a próxima

- **Entrar (<kbd>F11</kbd>)**: Entrar nas chamadas de função

- **Sair (<kbd>Shift</kbd> + <kbd>F11</kbd>)**: Sair da função atual
