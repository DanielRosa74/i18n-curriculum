...
Wie Sie sich aus früheren Lektionen erinnern, können Sie die `map()`-Methode verwenden, um die verschiedenen Objekte durchzulaufen und die Komponenten dynamisch so zu rendern:
