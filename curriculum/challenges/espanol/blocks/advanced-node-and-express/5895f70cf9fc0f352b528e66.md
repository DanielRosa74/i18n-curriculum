...
Agrega las dos funciones anteriores a tu servidor. La clase `ObjectID` proviene del paquete `mongodb`. `mongodb@~3.6.0` ya ha sido agregada como dependencia. Declara esta clase con:
