...
يجب أن يحتوي كودك على وسم `article` افتتاحي.

```js
assert.match(code, /<article>/i);
```

يجب أن يحتوي كودك على وسم `article` إغلاقي.
...
يجب أن يحتوي كودك على وسم `h3` افتتاحي.

```js
assert.match(code, /<h3>/i);
```

يجب أن يحتوي كودك على وسم `h3` إغلاقي.
