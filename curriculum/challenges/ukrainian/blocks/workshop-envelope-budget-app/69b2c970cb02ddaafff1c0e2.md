...
Далі створіть другий `fieldset` елемент з `id`, встановленим на `food`.

Всередині цього елемента створіть `legend` елемент з текстом `Food` та порожній `div` з `class`, встановленим на `input-container`.
...
Ваш другий `fieldset` елемент повинен мати `id`, встановлений на `food`.
...
Ваш новий `legend` елемент повинен містити текст `Food`.
