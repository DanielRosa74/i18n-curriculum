...
A continuación, agrega el estado de inscripción del estudiante a los datos de la boleta de calificaciones. Esto puede representarse usando un valor booleano.
