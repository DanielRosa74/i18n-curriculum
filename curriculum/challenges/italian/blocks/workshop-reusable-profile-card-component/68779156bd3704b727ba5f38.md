...
Come ricorderai dalle lezioni precedenti, puoi usare il metodo `map()` per iterare su diversi oggetti e renderizzare dinamicamente i componenti in questo modo:
