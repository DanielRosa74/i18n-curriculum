...
- Cross-site Scripting (XSS): Aprendiste sobre esto en una lección anterior. Pero para refrescar, los ataques XSS ocurren cuando un atacante inyecta scripts maliciosos en una página web que es vista por otros usuarios. Estos scripts pueden ejecutarse en el contexto del navegador de la víctima, potencialmente robando cookies y datos de sesión o realizando otras acciones maliciosas sin el conocimiento o consentimiento del usuario.
