...
- Kila lango lina safu ya data ya `queue` inayoonyesha ni wangapi washiriki wanafika katika kila alama za kupigia.
- Kwa kuwa milango yote ina idadi sawa ya alama za kupigia, unaweza kutumia tu urefu wa safu ya data ya `queue` ya lango la kwanza.
