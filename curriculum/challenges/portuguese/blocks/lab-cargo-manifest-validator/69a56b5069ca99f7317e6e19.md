...
**Nota:** Nem `normalizeUnits`, nem `validateManifest`, nem `processManifest` devem ser declarados usando `const`, pois os testes precisam reatribuí-los.
...
Nem `normalizeUnits`, nem `validateManifest`, nem `processManifest` devem ser declarados usando `const`, pois os testes precisam reatribuí-los.
