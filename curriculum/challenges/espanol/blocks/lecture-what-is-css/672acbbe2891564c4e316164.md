...
Luego hay una coma seguida de un selector de `class` que apunta a todos los elementos HTML con el valor de `class` igual a `subheading`. Todos los selectores de clase deben comenzar con un punto (`.`).
