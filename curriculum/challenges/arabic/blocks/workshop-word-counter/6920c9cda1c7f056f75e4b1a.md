...
أضف حلقة `for...of` مع كتلة كود فارغة داخل دالتك. يجب أن تقوم بالتكرار على كل حرف في المعلمة `str`.

# --hints--

يجب أن تحتوي دالة `printCharacters` على حلقة `for...of` داخل كتلة الكود الخاصة بها.
