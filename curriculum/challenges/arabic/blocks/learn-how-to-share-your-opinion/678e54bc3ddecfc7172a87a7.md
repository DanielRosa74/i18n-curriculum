...
`Debugging` هو عملية تحديد وتصحيح المشاكل أو الأخطاء في الكود لضمان عمل البرنامج كما هو متوقع. على سبيل المثال:

`The team spent several hours debugging the app to fix the crash that happened on startup.` - يشير إلى أن الفريق عمل على إيجاد الخطأ في كود التطبيق وتصحيحه لمنع حدوث التعطل.
