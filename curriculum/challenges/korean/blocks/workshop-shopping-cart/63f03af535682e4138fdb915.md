...
`totalNumberOfItems` 요소의 `textContent`를 `0`으로 설정하고, `cartSubTotal`, `cartTaxes`, `cartTotal` 요소들의 `textContent`를 `"$0"`으로 설정하세요.
...
`cartSubTotal` 요소의 `textContent`를 `"$0"`으로 설정하세요.
...
`cartTaxes` 요소의 `textContent`를 `"$0"`으로 설정하세요.
...
`cartTotal` 요소의 `textContent`를 `"$0"`으로 설정하세요.
