...
Ihr nächster Schritt ist es, den Nutzenden zu erlauben, Einträge zum Envelope Budgeter hinzuzufügen. Deklarieren Sie eine leere Funktion `addEntry`. Diese Funktion soll keine Parameter erhalten.
