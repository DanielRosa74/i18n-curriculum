...
Después de la asignación de la variable `current`, crea un ciclo `for` para iterar sobre las tuplas en la lista `graph[current]`. Necesitarás dos variables para iterar. Recuerda usar `pass` para completar el cuerpo del ciclo.
