...
أنشئ ثلاثة عناصر `li` جديدة داخل عنصر `ul` الخاص بك مع `className` بقيمة `sub-menu`.

# --hints--

يجب أن تنشئ ثلاثة عناصر `li` جديدة داخل عنصر `ul` الخاص بك مع `className` بقيمة `sub-menu`.
