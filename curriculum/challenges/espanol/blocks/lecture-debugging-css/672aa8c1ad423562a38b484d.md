...
Comencemos con las herramientas para desarrolladores del navegador, comúnmente conocidas como DevTools. La mayoría de los navegadores modernos, incluidos Chrome, Firefox y Safari, cuentan con DevTools integrados. Para acceder a ellas, puedes hacer clic derecho en un elemento de tu página web y seleccionar "Inspeccionar" o usar atajos de teclado como <kbd>F12</kbd> o <kbd>Cmd</kbd> + <kbd>Option</kbd> + <kbd>I</kbd> (en macOS).
