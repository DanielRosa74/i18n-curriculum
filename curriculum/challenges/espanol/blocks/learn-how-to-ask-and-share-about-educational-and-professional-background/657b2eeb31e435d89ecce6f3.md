...
A menudo, puedes agregar `-ly` a un adjetivo para convertirlo en un adverbio. Los adverbios son palabras que indican cómo se dice o se hace algo. Así que, cuando agregas `-ly` a `actual`, obtienes `actually`, que es un adverbio.
