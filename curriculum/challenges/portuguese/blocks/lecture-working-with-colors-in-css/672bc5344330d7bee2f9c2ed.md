...
Ao trabalhar com CSS para estilizar uma página, um dos métodos mais comuns para definir cores é usar valores de cor hexadecimais. Valores de cor hexadecimal, ou códigos hex, são uma forma concisa de representar cores no modelo de cor RGB. Nesta lição, vamos explorar o que são códigos hex, como eles funcionam no CSS e quando usá-los.

## Como os códigos hexadecimais funcionam
...
## Usando códigos hexadecimais no CSS
...
## Forma abreviada dos códigos hexadecimais
