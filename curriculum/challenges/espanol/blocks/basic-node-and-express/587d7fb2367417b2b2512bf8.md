...
title: Obtener datos de solicitudes POST
challengeType: 2
forumTopicId: 301511
...
También hay un par de otros métodos que se usan para negociar una conexión con el servidor. Excepto GET, todos los demás métodos listados arriba pueden tener una carga útil (es decir, los datos en el cuerpo de la solicitud). El middleware body-parser también funciona con estos métodos.
