...
**ملاحظة:** لا يجب وجود أي فراغات بين اسم المصفوفة والأقواس المربعة، مثل `array [0]`. رغم أن JavaScript يستطيع معالجة هذا بشكل صحيح، قد يربك هذا المبرمجين الآخرين الذين يقرؤون كودك.
