...
ابنِ تطبيق JavaScript متكامل الوظائف يشبه هذا: <a href="https://issue-tracker.freecodecamp.rocks/" target="_blank" rel="noopener noreferrer nofollow">https://issue-tracker.freecodecamp.rocks/</a>. يتطلب العمل على هذا المشروع كتابة الكود باستخدام إحدى الطرق التالية:
