...
Então, quando você deve usar a sintaxe de arrow function? Bem, depende. Muitos desenvolvedores a usam consistentemente em seus projetos pessoais. No entanto, ao trabalhar em equipe, a escolha geralmente depende se a base de código existente usa funções regulares ou arrow functions. Nas próximas lições, vamos abordar quando usar arrow functions e quando evitá-las.
