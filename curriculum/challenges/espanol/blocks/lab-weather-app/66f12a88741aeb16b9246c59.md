...
Además de la primera opción vacía, el elemento `select` debe contener 6 elementos `option`, uno para cada una de las siguientes ciudades: París, Londres, Tokio, Los Ángeles, Chicago, Nueva York.
