...
Você deve fazer um loop por cada propriedade no objeto `summary` e registrar a seguinte mensagem uma vez para cada propriedade: `gate + ": " + summary[gate] + " attendees processed"`.
