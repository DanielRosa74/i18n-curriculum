...
Para usar o Lighthouse, abra suas ferramentas de desenvolvimento pressionando <kbd>F12</kbd> e vá para a aba Lighthouse.
Selecione as métricas que deseja verificar, escolha o dispositivo para testar e clique no botão "Analyze page load".
...
Para usar o IBM Accessibility Checker como extensão do Chrome, faça o download na Chrome web store. Abra suas ferramentas de desenvolvimento pressionando <kbd>F12</kbd> e selecione a aba "Accessibility Checker" localizada no painel Elements. Clique no botão de escanear para iniciar a verificação e um relatório será gerado para você. Você pode exportar o relatório como uma planilha e um arquivo HTML clicando no botão "Export XLS".
