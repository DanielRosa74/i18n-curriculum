...
All'interno del tuo `div`, aggiungi due elementi `p`. Imposta il testo del secondo elemento `p` come un simbolo del dollaro seguito dal valore della variabile `price`.
...
Il tuo secondo elemento `p` dovrebbe avere un simbolo del dollaro seguito dal valore della variabile `price`.
