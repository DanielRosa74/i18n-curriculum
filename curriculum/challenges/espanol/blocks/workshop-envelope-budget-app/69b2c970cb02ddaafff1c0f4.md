...
El regex también puede tomar banderas específicas para alterar el comportamiento de coincidencia del patrón. Las banderas se agregan después del cierre `/`. La bandera `g`, que significa "global", indicará al patrón que continúe buscando después de haber encontrado una coincidencia. Aquí tienes un ejemplo:
