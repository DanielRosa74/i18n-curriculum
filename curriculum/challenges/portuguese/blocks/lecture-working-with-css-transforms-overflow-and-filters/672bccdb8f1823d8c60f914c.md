...
Geralmente é escrito no topo da folha de estilos CSS. O seletor asterisco é um seletor curinga que corresponde a todos os elementos HTML, então eles terão uma margem padrão zero e um preenchimento padrão zero em todos os quatro lados. Isso vai te dar um ponto de partida e depois você pode personalizá-los em seletores CSS mais específicos mais abaixo na folha de estilos.
...
Outra opção é o `sanitize.css`. Essa é uma biblioteca CSS que você pode usar para garantir que os estilos padrão sejam consistentes em todos os principais navegadores modernos. Essa biblioteca é desenvolvida junto com o `Normalize.css`, então elas evoluem juntas. Também possui folhas de estilos individuais que você pode baixar para propósitos específicos, como normalizar formulários e tipografia.
...
## Considerações sobre acessibilidade e desempenho
