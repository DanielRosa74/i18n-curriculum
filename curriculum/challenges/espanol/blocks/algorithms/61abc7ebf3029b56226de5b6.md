...
La función recibe un arreglo ordenado de enteros y un valor objetivo como entrada. Devuelve un arreglo que contiene (en orden) el valor medio que encontraste en cada división a la mitad del arreglo original hasta que encontraste el valor objetivo. El valor objetivo debe ser el último elemento del arreglo devuelto. Si no se encuentra el valor, devuelve la cadena `Value Not Found`.
