...
除了第一个空的选项外，`select` 元素还应包含 6 个 `option` 元素，分别对应以下城市：巴黎、伦敦、东京、洛杉矶、芝加哥、纽约。
...
当选择 New York 时，`showWeather` 函数应在相应的 HTML 元素中显示来自 API 的数据。如果 API 的值为 `undefined`，你应显示 `N/A`。
...
当选择 Chicago 时，`showWeather` 函数应在相应的 HTML 元素中显示来自 API 的数据。如果 API 的值为 `undefined`，你应显示 `N/A`。
...
当选择伦敦时，`showWeather` 函数应在相应的 HTML 元素中显示来自 API 的数据。如果来自 API 的值是 `undefined`，你应显示 `N/A`。
...
当选择东京时，`showWeather` 函数应在相应的 HTML 元素中显示来自 API 的数据。如果 API 的值为 `undefined`，你应显示 `N/A`。
...
当选择 Los Angeles 时，`showWeather` 函数应在相应的 HTML 元素中显示来自 API 的数据。如果来自 API 的值是 `undefined`，你应显示 `N/A`。
