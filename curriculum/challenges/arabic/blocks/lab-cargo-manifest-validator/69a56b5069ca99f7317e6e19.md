...
**ملاحظة:** لا يجب إعلان `normalizeUnits` أو `validateManifest` أو `processManifest` باستخدام `const`، لأن الاختبارات تحتاج إلى إعادة تعيينها.
...
لا يجب إعلان `normalizeUnits` أو `validateManifest` أو `processManifest` باستخدام `const`، لأن الاختبارات تحتاج إلى إعادة تعيينها.
