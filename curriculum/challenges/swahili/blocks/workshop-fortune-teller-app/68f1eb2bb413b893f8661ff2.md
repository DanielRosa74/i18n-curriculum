...
Ndani ya njia ya `newReading`, fanya wito wa `showElements` na pita `this.elements.singleCardBtn`, `this.elements.multipleCardsBtn`, na `this.elements.headerTitle` kama hoja.

Kisha fanya wito wa `hideElements` na pita `this.elements.singleCard`, `this.elements.multipleCard`, `this.elements.fortuneContainer`, na `this.elements.fortuneDescription` kama hoja.
