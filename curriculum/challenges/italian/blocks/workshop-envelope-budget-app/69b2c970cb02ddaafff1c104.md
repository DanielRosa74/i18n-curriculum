...
Il prossimo passaggio è permettere agli utenti di aggiungere elementi al budgeter a buste. Dichiara una funzione vuota `addEntry`. Questa funzione non deve prendere alcun parametro.
