...
Strings e números podem ser nossos blocos de construção, mas conforme seus scripts ficam mais complexos, você vai precisar de uma forma de lidar com grandes quantidades deles. Felizmente, o JavaScript tem alguns tipos de dados usados exatamente para isso. Um array é uma coleção ordenada de itens (strings, números ou outras coisas).
