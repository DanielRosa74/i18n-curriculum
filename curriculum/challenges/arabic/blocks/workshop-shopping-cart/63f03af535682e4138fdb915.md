...
عيّن قيمة `textContent` لعنصر `totalNumberOfItems` إلى `0`، وقيمة `textContent` لعناصر `cartSubTotal` و`cartTaxes` و`cartTotal` إلى `"$0"`.
...
يجب أن تعيّن قيمة `textContent` لعنصر `cartSubTotal` إلى `"$0"`.
...
يجب أن تعيّن قيمة `textContent` لعنصر `cartTaxes` إلى `"$0"`.
...
يجب أن تعيّن قيمة `textContent` لعنصر `cartTotal` إلى `"$0"`.
