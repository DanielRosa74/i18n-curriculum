...
Unahitaji kutengeneza mfuatano wa herufi wa HTML ambao utaonyeshwa katika kipengele cha `output`.

Anza kwa kuweka thamani ya template literal tupu kwenye sifa ya `innerHTML` ya kipengele cha `output` kwenye mstari mpya mwishoni mwa tamko la `if`.
