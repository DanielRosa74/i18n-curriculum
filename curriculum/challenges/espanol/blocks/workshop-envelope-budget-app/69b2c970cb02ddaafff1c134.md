...
Ahora crea un elemento `p` con el texto `$${income} Total Income`, usando interpolación para reemplazar income con la variable apropiada.
...
Tu elemento `p` debe tener el texto `$${income} Total Income`.
