...
¿Qué es un modal? Es el tipo de ventana emergente que un sitio web puede mostrarte sobre su contenido. HTML tiene un elemento `dialog` que puedes usar para crear modales.
