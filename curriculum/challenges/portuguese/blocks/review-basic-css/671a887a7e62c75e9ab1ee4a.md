...
- **Anatomia básica de uma regra CSS**: Uma regra CSS é composta por duas partes principais: um seletor e um bloco de declarações. Um seletor é um padrão usado no CSS para identificar e direcionar elementos HTML específicos para estilização. Um bloco de declarações aplica um conjunto de estilos para um ou mais seletores.
