...
En tu nueva función, declara una variable `total` y asígnale el valor `0`. Usa `let` para declararla, ya que la reasignarás más adelante.

# --hints--

Debes declarar una variable `total`.
...
Tu variable `total` debe tener asignado el valor `0`.
...
Debes declarar tu variable `total` con `let`.
