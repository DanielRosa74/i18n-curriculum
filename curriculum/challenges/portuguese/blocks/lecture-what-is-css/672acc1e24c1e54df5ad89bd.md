...
Os dois elementos de parágrafo não compartilham a mesma linha porque são elementos block-level por padrão.

Então, ambos os elementos de parágrafo ocuparão toda a largura do seu container, que neste caso é o elemento `body`.
