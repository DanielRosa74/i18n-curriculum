...
<ol>
  <li>Mueve el último elemento del montículo a la posición de la raíz.</li>
  <li>Si alguno de los hijos de la raíz es mayor que ella, intercambia la raíz con el hijo de mayor valor.</li>
  <li>Continúa intercambiando hasta que el padre sea mayor que ambos hijos o llegues al último nivel del árbol.</li>
</ol>
