...
Prova ad aggiungere un paio di elementi alla categoria `Food` e potresti notare qualche bug! La prima cosa da sistemare sono i conteggi degli elementi: il primo elemento dovrebbe avere un conteggio di `1`, non di `0`.
