...
Al trabajar con CSS para diseñar una página web, uno de los métodos más comunes para definir colores es usar valores de color hexadecimales. Los valores de color hexadecimal, o códigos hex, son una forma concisa de representar colores en el modelo de color RGB. En esta lección, exploraremos qué son los códigos hex, cómo funcionan en CSS y cuándo usarlos.
...
## Uso de códigos hexadecimales en CSS
...
## Forma abreviada de los códigos hexadecimales
