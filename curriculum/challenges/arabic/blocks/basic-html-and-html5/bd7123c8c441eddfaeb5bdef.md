...
أولًا، ستبدأ ببناء صفحة ويب بسيطة باستخدام HTML. يمكنك تعديل الكود في محرر الكود الخاص بك، الذي تم تضمينه في هذه الصفحة.

هل ترى الكود في محرر الكود الخاص بك الذي يقول `<h1>Hello</h1>`؟ هذا عنصر HTML.
