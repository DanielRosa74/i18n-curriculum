...
У регулярних виразах скорочені класи символів дозволяють співставляти певні символи, не записуючи їх безпосередньо у вашому шаблоні.

Скорочені класи символів передують зворотною скісною рискою (`\`). Клас символів `\s` співпадає з будь-яким пробільним символом. Додайте це в кінець вашого регулярного виразу.
