...
Necesitas un bloque de código `fieldset` más para `entertainment`.
...
Tu cuarto elemento `fieldset` debe tener un `id` establecido en `entertainment`.
...
Tu cuarto elemento `legend` debe tener el texto `Entertainment`.
