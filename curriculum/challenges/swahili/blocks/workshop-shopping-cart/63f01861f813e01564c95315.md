...
Ndani ya `div` yako, ongeza vipengele viwili vya `p`. Weka maandishi ya kipengele cha pili cha `p` kuwa alama ya dola ikifuatiwa na thamani ya kigezo cha `price`.
...
Kipengele chako cha pili cha `p` kinapaswa kuwa na alama ya dola ikifuatiwa na thamani ya kigezo cha `price`.
