...
Qual operador você pode usar para concatenar strings em Python?
...
Revise a seção Concatenando strings da lição.
...
Usando o operador `%` para combinar strings.
...
Ela retorna uma versão em string do valor dado.
