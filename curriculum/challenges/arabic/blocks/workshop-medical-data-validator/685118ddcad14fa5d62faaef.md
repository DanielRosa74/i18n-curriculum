...
تتحقق العاملتان `is` و `is not` مما إذا كانت قيمتان تشير إلى نفس الكائن. يُسمى هذا مقارنة الهوية. يمكنك استخدام `is None` للتحقق مما إذا كانت القيمة هي الكائن `None`، و`is not None` للتحقق مما إذا لم تكن هي الكائن `None`.
