...
**Примітка:** ні `normalizeUnits`, ні `validateManifest`, ні `processManifest` не слід оголошувати за допомогою `const`, оскільки тести потребують можливості переназначення цих функцій.
...
Ні `normalizeUnits`, ні `validateManifest`, ні `processManifest` не слід оголошувати за допомогою `const`, оскільки тести потребують можливості переназначення цих функцій.
