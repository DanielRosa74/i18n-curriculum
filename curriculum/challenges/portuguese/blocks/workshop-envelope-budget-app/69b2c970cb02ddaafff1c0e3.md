...
Continuando o padrão, crie um `fieldset` para `utilities` com os mesmos elementos aninhados.
...
Seu terceiro elemento `fieldset` deve ter um `id` definido como `utilities`.
...
Seu novo elemento `legend` deve ter o texto `Utilities`.
