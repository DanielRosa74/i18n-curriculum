...
Cada entrada terá uma entrada de texto para o nome da entrada e uma entrada numérica para o orçamento. Para obter a contagem do número de entradas, você pode fazer uma consulta pelas entradas de texto.
