...
<blockquote>[ ] -> Los corchetes representan un arreglo.<br>{ } -> Las llaves representan un objeto.<br>" " -> Las comillas dobles representan una cadena. También se usan para los nombres de las claves en JSON.</blockquote>
...
Otro "par clave-valor" interesante en el primer objeto es `"codeNames":["Juggernaut","Mrs. Wallace","ButterCup"]`. Aquí `codeNames` es la clave y su valor es un arreglo de tres cadenas. Es posible tener arreglos de objetos así como una clave con un arreglo como valor.
