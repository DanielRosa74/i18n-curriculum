...
لإنهاء الأمر، عدّل الكود الذي كتبته خارج الأصناف، وادمجه في دالة مساعدة صغيرة تُسمى `projectile_helper` تأخذ القيم المطلوبة للسرعة والارتفاع والزاوية، وتطبع إلى الطرفية بالتتابع تفاصيل المقذوف، وجدول الإحداثيات، ورسم مسار المقذوف.
