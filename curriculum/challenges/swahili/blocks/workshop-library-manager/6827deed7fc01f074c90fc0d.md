...
Chini ya `console.log()` hiyo, ongeza `console.log()` nyingine. Ndani ya `console.log()` hiyo, fanya wito wa kitendakazi cha `getBooksByAuthor()` kwa kutumia `library` na `"James Clear"` kama hoja.
