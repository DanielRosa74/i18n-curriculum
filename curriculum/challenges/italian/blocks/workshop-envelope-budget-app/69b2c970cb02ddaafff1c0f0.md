...
Dichiara una variabile `regex` e assegna il valore dell'esempio sopra. Nei passaggi successivi aggiornerai questo pattern di espressione regolare per far corrispondere i caratteri specifici necessari per il budgeter a buste.
