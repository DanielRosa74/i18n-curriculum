...
تعني كلمة `maintain` الحفاظ على شيء في حالة أو وضع معين. على سبيل المثال، إذا حدثت الكود الخاص بك بانتظام وقمت بمعالجة الأخطاء / تصحيح الأخطاء، فأنت تحافظ على وظيفته.
