...
Para deixar uma caixa de seleção `input` marcada por padrão, você pode adicionar o atributo `checked`.
...
Adicione o atributo `checked` à caixa de seleção `input` com o `id` `"reputation"` para que ela fique marcada por padrão.

# --hints--

Sua caixa de seleção `input` com o `id` `"reputation"` deve ter o atributo `checked`.
