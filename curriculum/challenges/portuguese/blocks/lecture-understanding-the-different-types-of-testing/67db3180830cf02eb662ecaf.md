...
Você foi apresentado às assertivas e testes unitários em uma lição anterior. Mas para revisar, teste unitário é quando você verifica a saída de funções ou componentes individuais de forma independente, em contraste com testar a saída final de todo o programa. As assertivas são usadas para testar se o código está se comportando como esperado.
