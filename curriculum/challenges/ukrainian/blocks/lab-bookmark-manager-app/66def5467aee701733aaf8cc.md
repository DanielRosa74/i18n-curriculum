...
Коли ви натискаєте на `#view-category-button`, ви повинні викликати `displayOrHideCategory`, щоб показати розділ зі списком закладок і приховати головний розділ.
