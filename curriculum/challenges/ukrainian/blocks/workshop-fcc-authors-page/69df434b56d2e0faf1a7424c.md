...
Оскільки ваш виклик `fetch` не визначений ні в асинхронній функції, ні в основному тілі модуля, ви не можете використовувати `await`, поки це не виправите.
...
Ваша змінна `initialFetch` має бути функцією.
...
Ваша змінна `initialFetch` має бути асинхронною функцією.
...
Ваша функція `initialFetch` має використовувати синтаксис стрілкової функції.
