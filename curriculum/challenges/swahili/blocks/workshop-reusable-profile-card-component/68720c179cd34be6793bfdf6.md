...
Ondoa sehemu tatu za `<Card />` ndani ya kipengele cha `<div className="flex-container">`. Katika hatua chache zijazo, utaunda safu ya data na utumie njia ya `map()` kuonyesha sehemu za `Card`, ambayo ni njia inayotumika zaidi katika React.
