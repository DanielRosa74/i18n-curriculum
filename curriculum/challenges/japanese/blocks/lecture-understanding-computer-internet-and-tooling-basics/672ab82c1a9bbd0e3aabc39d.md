...
多くの方は、ゲーム、仕事のタスク、ウェブの閲覧など、さまざまな活動で長年キーボードとマウスを使ってきました。
...
最後のヒントは、可能な限りキーボードショートカットを使ってマウスを使う回数を減らすことです。ウェブの操作、OSのナビゲーション、コードエディターでの作業など、多くのタスクに使えるショートカットが数多くあります。ですので、これらのキーボードショートカットを調べて、日々のコンピューター使用に取り入れることをお勧めします。
