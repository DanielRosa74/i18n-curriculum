...
En este ejemplo, usamos propiedades como `position`, `clip` y `white-space`, que aprenderás en lecciones futuras. Por ahora, solo debes saber que esta regla CSS oculta el contenido visualmente mientras lo mantiene accesible para los lectores de pantalla. Es útil para proporcionar contexto adicional a los usuarios de lectores de pantalla sin afectar el diseño visual.
