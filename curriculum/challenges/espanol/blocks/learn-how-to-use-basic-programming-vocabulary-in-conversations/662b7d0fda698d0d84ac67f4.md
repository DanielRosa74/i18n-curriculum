...
El patrón `by` seguido de la forma `-ing` de un verbo es una forma común de explicar cómo se hace o se logra algo. Enfatiza el método o proceso involucrado. Un ejemplo es `You can improve your English by practicing every day.`
