...
Agora, vamos falar sobre o runtime do JavaScript. O runtime do JavaScript é o ambiente onde seu código JavaScript é executado. Ele inclui o motor JavaScript (como o V8 no Chrome ou o SpiderMonkey no Firefox), que processa e executa o código, além de recursos adicionais fornecidos pelo ambiente (como um navegador web ou o Node.js, que você vai aprender mais nas próximas lições).
