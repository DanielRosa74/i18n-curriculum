...
الآن، احذف الأسطر التالية من أسفل كودك:
...
يجب ألا يحتوي كودك على السطر `print(product)`.
...
يجب ألا يحتوي كودك على السطر `discount = PercentageDiscount(10)`.
...
يجب ألا يحتوي كودك على السطر `print(discount.apply_discount(product))`.
...
يجب ألا يحتوي كودك على السطر `fixed_discount = FixedAmountDiscount(5)`.
...
يجب ألا يحتوي كودك على السطر `print(fixed_discount.apply_discount(product))`.
