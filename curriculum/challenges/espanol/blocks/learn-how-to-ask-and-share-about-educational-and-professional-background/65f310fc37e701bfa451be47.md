...
La palabra `major` es un verbo regular. En pasado, a menudo puedes agregar `-ed` al final de los verbos regulares. Así, `major` se convierte en `majored` para hablar del pasado.
