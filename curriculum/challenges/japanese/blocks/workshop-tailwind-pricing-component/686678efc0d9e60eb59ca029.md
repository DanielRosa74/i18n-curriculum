...
テキストが`Most popular`の`div`要素には`bg-gradient-to-r`のクラスを付けてください。
...
テキストが`Most popular`の`div`要素には`from-fuchsia-500`のクラスを付けてください。
...
テキストが`Most popular`の`div`要素には`to-indigo-500`のクラスを付けてください。
...
テキストが`Most popular`の`div`要素には`rounded-full`のクラスを付けてください。
...
テキストが`Most popular`の`div`要素には`px-3`のクラスを付けてください。
...
テキストが`Most popular`の`div`要素には`py-1`のクラスを付けてください。
...
テキストが`Most popular`の`div`要素には`text-xs`のクラスを付けてください。
...
テキストが`Most popular`の`div`要素には`font-bold`のクラスを付けてください。
...
テキストが`Most popular`の`div`要素には`text-white`のクラスを付けてください。
