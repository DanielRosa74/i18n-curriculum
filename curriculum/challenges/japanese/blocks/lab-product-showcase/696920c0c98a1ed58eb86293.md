...
`Item`インターフェースには`string`型の`id`プロパティが必要です。
...
`Item`インターフェースには`number`型の`price`プロパティが必要です。
...
`Book`インターフェースには`"book"`に設定された`type`プロパティが必要です。
...
`Book`インターフェースには`string`型の`title`プロパティが必要です。
...
`Book`インターフェースには`string`型の`author`プロパティが必要です。
...
`Electronics`インターフェースには`"electronics"`に設定された`type`プロパティが必要です。
...
`Electronics`インターフェースには`string`型の`item`プロパティが必要です。
...
`Electronics`インターフェースには`string`型の`model`プロパティが必要です。
...
`Clothing`インターフェースには`"clothing"`に設定された`type`プロパティが必要です。
...
`Clothing`インターフェースには`string`型の`item`プロパティが必要です。
...
`Clothing`インターフェースには`string`型の`brand`プロパティが必要です。
