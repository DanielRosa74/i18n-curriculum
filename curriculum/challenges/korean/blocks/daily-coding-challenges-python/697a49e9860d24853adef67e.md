...
title: "도전 과제 193: 겨울 경기 14일차: 스키 산악 등반"
challengeType: 29
...
`avalanche_risk("Shallow", "Gentle")`는 `"Safe"`를 반환해야 합니다.
...
`avalanche_risk("Shallow", "Steep")`는 `"Safe"`를 반환해야 합니다.
...
`avalanche_risk("Shallow", "Very Steep")`는 `"Safe"`를 반환해야 합니다.
...
`avalanche_risk("Moderate", "Gentle")`는 `"Safe"`를 반환해야 합니다.
...
`avalanche_risk("Moderate", "Steep")`는 `"Risky"`를 반환해야 합니다.
...
`avalanche_risk("Moderate", "Very Steep")`는 `"Risky"`를 반환해야 합니다.
...
`avalanche_risk("Deep", "Gentle")`는 `"Safe"`를 반환해야 합니다.
...
`avalanche_risk("Deep", "Steep")`는 `"Risky"`를 반환해야 합니다.
...
`avalanche_risk("Deep", "Very Steep")`는 `"Risky"`를 반환해야 합니다.
