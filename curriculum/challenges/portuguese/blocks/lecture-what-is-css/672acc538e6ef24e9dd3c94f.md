...
Aqui está um exemplo de uso de dois valores para a notação abreviada `margin`:
...
Como você pode ver, o `padding` é aplicado ao conteúdo que está dentro da borda, diferente do `margin` que é aplicado fora da borda.
