...
أضف طريقة `style()` إلى الكود في المحرر لتعيين `color` لعناصر `h2` بشكل شرطي. اكتب دالة استدعاء راجع بحيث إذا كانت قيمة البيانات أقل من 20، تُرجع اللون الأحمر، وإلا تُرجع اللون الأخضر.
