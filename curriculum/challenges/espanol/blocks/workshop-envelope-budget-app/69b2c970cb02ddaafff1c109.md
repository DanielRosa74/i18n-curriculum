...
Cada entrada tendrá un campo de texto para el nombre de la entrada y un campo numérico para el presupuesto. Para obtener un conteo del número de entradas, puedes hacer una consulta por los campos de texto.
