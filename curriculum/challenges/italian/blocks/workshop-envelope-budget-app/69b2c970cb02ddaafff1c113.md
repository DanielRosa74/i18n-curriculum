...
Il tuo altro bug si verifica se aggiungi una voce `Food`, la compili, poi aggiungi una seconda voce `Food`. Vedrai che i valori che hai aggiunto sono scomparsi.
