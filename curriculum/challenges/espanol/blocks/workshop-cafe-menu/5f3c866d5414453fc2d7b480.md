...
Comenzando debajo del par café/precio existente, agrega los siguientes cafés y precios usando elementos `article` con dos elementos `p` anidados dentro de cada uno.
