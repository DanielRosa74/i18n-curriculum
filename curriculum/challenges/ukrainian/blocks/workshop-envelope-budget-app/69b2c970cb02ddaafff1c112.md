...
Спробуйте додати кілька записів до категорії `Food`, і ви можете помітити деякі помилки! Перше, що потрібно виправити, — це підрахунок записів: перший запис має мати значення `1`, а не `0`.
