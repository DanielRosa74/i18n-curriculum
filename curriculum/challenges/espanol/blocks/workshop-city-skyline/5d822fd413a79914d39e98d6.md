...
Ahora tienes algo que se parece a un edificio. Estás listo para crear tu primera variable. En lecciones anteriores aprendiste que las declaraciones de variables comienzan con dos guiones (`-`) y se les asigna un nombre y un valor así: `--variable-name: value;`. En la regla para la clase `bb1`, crea una variable llamada `--building-color1` y asígnale un valor de `#999`.
