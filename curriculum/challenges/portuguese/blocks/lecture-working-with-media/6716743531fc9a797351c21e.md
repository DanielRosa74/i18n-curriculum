...
O próprio elemento é substituído pelo objeto externo: a imagem. Seu CSS pode controlar coisas como o posicionamento da imagem ou aplicar um filtro nela, mas você não pode modificar a imagem em si. Um exemplo mais robusto pode ser o elemento `iframe`, que incorpora um site externo na sua página web.
