...
Wenn Sie auf `#view-category-button` klicken, sollten Sie `displayOrHideCategory` aufrufen, um den Abschnitt mit der Lesezeichenliste anzuzeigen und den Hauptabschnitt auszublenden.
