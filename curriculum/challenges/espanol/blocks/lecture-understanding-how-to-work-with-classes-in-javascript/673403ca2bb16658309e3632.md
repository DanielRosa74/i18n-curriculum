...
¿Qué valor tendrá la palabra clave `this` en el contexto de este método? Se referirá al objeto sobre el que se está llamando el método. En este caso, estamos creando una nueva instancia de Dessert con el nombre `"Brownie"` y el precio `$5.99`:
