...
Seu próximo passo é permitir que os usuários adicionem entradas ao orçamentador de envelopes. Declare uma função vazia `addEntry`. Essa função não deve receber nenhum parâmetro.
