...
Dentro do método `newReading`, chame `showElements` e passe `this.elements.singleCardBtn`, `this.elements.multipleCardsBtn` e `this.elements.headerTitle` como argumentos.

Depois chame `hideElements` e passe `this.elements.singleCard`, `this.elements.multipleCard`, `this.elements.fortuneContainer` e `this.elements.fortuneDescription` como argumentos.
