...
All'interno del metodo `newReading`, chiama `showElements` e passa come argomenti `this.elements.singleCardBtn`, `this.elements.multipleCardsBtn` e `this.elements.headerTitle`.

Poi chiama `hideElements` e passa come argomenti `this.elements.singleCard`, `this.elements.multipleCard`, `this.elements.fortuneContainer` e `this.elements.fortuneDescription`.
