...
Basicamente, esta é uma implementação de "fizzbuzz" onde as regras do jogo são fornecidas para você. Crie uma função para implementar isso. A função deve receber dois parâmetros.
