...
También probablemente te encontrarás con el método `stopPropagation()`. Este método evita que el evento se propague o burbujee hacia los elementos padre. Aprenderás más sobre lo que esto significa en una lección futura.
