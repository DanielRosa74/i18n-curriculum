...
O CSS interno é melhor usado quando você precisa aplicar estilos a uma página específica em vez de várias páginas. É útil para sites de página única ou quando os estilos não precisam ser reutilizados em outros lugares.
