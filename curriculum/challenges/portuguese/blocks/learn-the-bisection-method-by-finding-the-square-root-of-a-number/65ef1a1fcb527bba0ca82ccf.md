...
Se o `square_target` for igual a `1`, declare uma variável `root` e atribua a ela o valor `1`. Também, imprima a mensagem `'The square root of {square_target} is 1'`. Lembre-se de formatar a mensagem usando uma f-string.
