...
Nas lições anteriores, você aprendeu como testar pequenas unidades de código por meio de unit testing. Na verdade, unit testing faz parte do functional testing. Functional testing verifica se os recursos e funções da aplicação funcionam como esperado.
