...
A largura atual do menu sempre ocupará `80%` da largura do elemento `body`. Em uma tela muito larga, os cafés e sobremesas aparecem muito distantes dos seus preços.
