...
Tu elemento `input` de ingreso necesita algunos atributos adicionales para asegurar que los usuarios ingresen valores válidos.

Actualiza el elemento `#income` que creaste con los siguientes atributos:

- `type` establecido en `number` (para permitir solo entradas numéricas)
- `min` establecido en `0` (para permitir solo números positivos)
- `placeholder` establecido en `e.g. 2000`
...
Tu elemento `input` debe tener un atributo `placeholder` establecido en `e.g. 2000`.
