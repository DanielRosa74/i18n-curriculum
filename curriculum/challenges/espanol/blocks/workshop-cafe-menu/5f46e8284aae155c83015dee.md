...
Bajo el título `Coffee`, agrega una imagen usando la URL `https://cdn.freecodecamp.org/curriculum/css-cafe/coffee.jpg`. Dale a la imagen un valor `alt` de `coffee icon`.
