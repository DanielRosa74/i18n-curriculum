...
En el siguiente ejemplo, veremos el pseudoelemento `::first-letter`. El pseudoelemento `::first-letter` selecciona la primera letra del contenido de un elemento, permitiéndote darle estilo. Aquí tienes un ejemplo de un texto en un párrafo. Si queremos darle estilo a la primera letra, podemos usar el pseudoelemento `::first-letter` así:
