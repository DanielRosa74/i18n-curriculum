...
title: "도전 과제 186: 겨울 경기 7일차: 스피드 스케이팅"
challengeType: 29
...
`largest_difference([26.11, 25.80, 25.92, 26.23, 26.07], [25.93, 25.74, 26.53, 26.11, 26.30])`는 `3`을 반환해야 합니다.
...
`largest_difference([27.04, 25.94, 26.22, 26.07, 26.18], [25.59, 25.80, 26.11, 26.01, 26.23])`는 `1`을 반환해야 합니다.
...
`largest_difference([25.82, 25.90, 26.05, 26.00, 26.48], [25.85, 25.92, 26.07, 25.98, 25.95])`는 `5`를 반환해야 합니다.
...
`largest_difference([25.88, 26.10, 25.95, 26.05, 26.00], [25.90, 26.55, 25.92, 26.03, 26.01])`는 `2`를 반환해야 합니다.
...
`largest_difference([25.92, 26.01, 26.05, 25.88, 26.12], [25.95, 26.00, 26.03, 26.45, 26.10])`는 `4`를 반환해야 합니다.
