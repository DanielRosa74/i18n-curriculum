...
계산 준비를 시작할 시간입니다. 먼저 `expenses` 변수를 선언하고, `rent`, `food`, `utilities`, `entertainment`의 합을 할당하세요(테스트에서는 순서가 중요하니 주의하세요). 이 작업은 if 문 다음에 하세요.

# --hints--

함수에는 `expenses` 변수가 있어야 합니다.
