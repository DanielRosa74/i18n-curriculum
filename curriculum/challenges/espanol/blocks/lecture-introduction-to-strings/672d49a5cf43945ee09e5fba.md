...
Para crear una cadena en JavaScript, puedes usar comillas simples (`'`) o comillas dobles (`"`).
...
Aquí tienes un ejemplo de intentar cambiar el primer carácter de una cadena, lo que genera un error:
...
Para cambiar el valor, asignas una cadena completamente nueva a la variable `developer`:
