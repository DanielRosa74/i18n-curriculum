...
ماذا يُنشئ التعبير `repeat(3, minmax(100px, 1fr))` عند استخدامه مع الخاصية `grid-template-columns`؟

#### --distractors--

ثلاثة أعمدة لا يمكن أن تنمو لتتجاوز `100px`.
...
يجعل العنصر يبدأ عند خط الصف الثاني.
