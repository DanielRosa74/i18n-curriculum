...
macOS y iOS tienen VoiceOver integrado. Puedes habilitarlo en tu computadora presionando <kbd>CMD</kbd> + <kbd>F5</kbd>. Puedes acceder a él en iPhones a través de Configuración.

Las computadoras con Windows tienen Narrator integrado. Puedes activarlo presionando <kbd>WIN</kbd> + <kbd>CTRL</kbd> + <kbd>ENTER</kbd>. NonVisual Desktop Access (NVDA) y Job Access With Speech (JAWS) también están disponibles para computadoras con Windows. NVDA es gratuito y de código abierto, mientras que JAWS es de pago.
