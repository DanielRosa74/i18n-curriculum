...
## فئات `:nth-child(n)` و `:nth-last-child(n)` المزيفة
...
## فئات `:first-child` و `:last-child` و `:only-child` المزيفة
...
## فئات `:first-of-type` و `:last-of-type` المزيفة
