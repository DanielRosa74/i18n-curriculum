...
Antes de trabalhar com variáveis em Python, é importante entender os tipos de dados. Um tipo de dado descreve o tipo de valor que uma variável armazena, por exemplo, um número, um texto ou uma lista de itens. As linguagens de programação usam tipos de dados para saber como armazenar e manipular diferentes tipos de informação.
...
A natureza de tipagem dinâmica do Python torna a codificação mais rápida e flexível, mas pode causar bugs inesperados porque erros de tipo são detectados apenas quando o programa é executado, não quando ele é compilado.
