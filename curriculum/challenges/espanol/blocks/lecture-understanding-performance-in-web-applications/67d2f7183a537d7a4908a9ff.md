...
A continuación, tenemos que minimizar las solicitudes HTTP. Cada archivo que tu sitio web solicita aumenta el tiempo de carga. Reducir el número de solicitudes HTTP puede llevar a cargas de página más rápidas. Puedes:
