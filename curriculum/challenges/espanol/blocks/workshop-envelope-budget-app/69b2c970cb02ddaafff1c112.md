...
Intenta agregar un par de entradas a la categoría `Food` y puede que notes algunos bugs. Lo primero que debemos corregir son los conteos de entradas: la primera entrada debería tener un conteo de `1`, no de `0`.
