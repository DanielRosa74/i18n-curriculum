...
最初の`p`要素内の`h2`要素の下に、テキスト`Red`を持つ`.box`要素を追加してください。
...
2番目の`p`要素内の`h2`要素の下に、テキスト`Orange`を持つ`.box`要素を追加してください。
...
3番目の`p`要素内の`h2`要素の下に、テキスト`Yellow`を持つ`.box`要素を追加してください。
...
4番目の`p`要素内の`h2`要素の下に、テキスト`Green`を持つ`.box`要素を追加してください。
...
5番目の`p`要素内の`h2`要素の下に、テキスト`Blue`を持つ`.box`要素を追加してください。
...
6番目の`p`要素内の`h2`要素の下に、テキスト`Indigo`を持つ`.box`要素を追加してください。
