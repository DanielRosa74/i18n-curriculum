...
Los tipos de datos primitivos son la forma más simple de datos en JavaScript. Incluyen número, bigint, cadena, booleano, `null`, `undefined` y símbolo. Estos tipos se llaman "primitivos" porque representan valores individuales y no son objetos.
