...
1. يجب أن يكون لديك عنصر `header`، ويجب أن يكون أول عنصر داخل `body`.
1. داخل عنصر `header`، يجب أن يكون لديك عنصر `h1` يحتوي على النص `Event Hub`، وعنصر `nav`.
1. داخل عنصر `nav`، يجب أن يكون لديك قائمة غير مرتبة تحتوي على عنصرين بهما روابط لأقسام مختلفة من الصفحة. يجب أن يحتوي العنصر الأول على النص `Upcoming Events`، والعنصر الثاني على النص `Past Events`.
1. يجب أن يُمثّل كل رابط بواسطة عنصر `a` مع خاصية `href` تشير إلى القسم المقابل من الصفحة، `#upcoming-events` و `#past-events` على التوالي.
