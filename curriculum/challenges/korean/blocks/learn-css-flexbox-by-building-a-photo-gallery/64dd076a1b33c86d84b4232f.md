...
`.gallery` 선택자에는 `50%`로 설정된 `width` 속성이 있어야 합니다.
...
`.gallery` 선택자에는 `5px solid red`로 설정된 `border` 속성이 있어야 합니다.
...
`img` 선택자에는 `100%`로 설정된 `width` 속성이 있어야 합니다.
...
`img` 선택자에는 `5px`로 설정된 `padding` 속성이 있어야 합니다.
...
`img` 선택자에는 `5px solid blue`로 설정된 `border` 속성이 있어야 합니다.
