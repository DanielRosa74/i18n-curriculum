...
텍스트 `Arc`를 포함하는 또 다른 `dt` 요소를 추가하세요.
...
다섯 번째 `dd` 요소에는 `This is a free Chromium-based web browser first released in 2023 by The Browser Company.`라는 텍스트가 포함되어야 합니다.
