...
En una lección anterior, aprendiste a usar HTML para restringir los valores que tus usuarios pueden enviar en tu formulario. Pero a veces eso no es suficiente. Si quieres hacerlo más complejo, como mostrar tus propios mensajes de error al usuario, necesitarás usar JavaScript.
...
## Configurar el formulario con validación HTML
...
## Restringir la entrada con el atributo `pattern`
...
## Comprobar la validez con `checkValidity()`
...
## Reportar la validez con `reportValidity()`
...
## Establecer un mensaje personalizado con `setCustomValidity()`
...
## Explorar la propiedad `validity`
