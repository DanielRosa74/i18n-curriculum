...
За цим самим шаблоном оголосіть змінні `utilities` та `entertainment` для `number` вхідних даних у елементах `#utilities` та `#entertainment`. Призначте їм відповідні виклики `getTotalFromInputs`.

# --hints--

У вашій функції `calculateBudget` має бути змінна `utilities`.
...
Ви маєте викликати `getTotalFromInputs` з `utilitiesInputs` як аргументом.

```js
assert.match(calculateBudget.toString(), /getTotalFromInputs\s*\(\s*utilitiesInputs\s*\)/);
```

Ви маєте призначити результат `getTotalFromInputs` змінній `utilities`.
...
У вашій функції `calculateBudget` має бути змінна `entertainment`.
...
Ви маєте викликати `getTotalFromInputs` з `entertainmentInputs` як аргументом.

```js
assert.match(calculateBudget.toString(), /getTotalFromInputs\s*\(\s*entertainmentInputs\s*\)/);
```

Ви маєте призначити результат `getTotalFromInputs` змінній `entertainment`.
