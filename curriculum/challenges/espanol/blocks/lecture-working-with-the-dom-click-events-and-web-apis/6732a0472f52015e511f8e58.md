...
La API DOM, que puedes usar para manipular elementos HTML, sus estilos y atributos. Aprenderás mucho más sobre el DOM en las próximas lecciones. Es un concepto fundamental en el desarrollo web.
