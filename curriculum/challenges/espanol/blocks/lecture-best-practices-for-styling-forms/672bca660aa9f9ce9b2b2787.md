...
Estos tipos especiales de entradas dependen de pseudoelementos complejos para crear cosas como los selectores de fecha y color. Esto representa un desafío importante para estilizar estas entradas. Un desafío es que, dado que el estilo predeterminado depende completamente del navegador, el CSS que hace que el selector se vea bien en un navegador puede producir un resultado muy diferente en otro.
