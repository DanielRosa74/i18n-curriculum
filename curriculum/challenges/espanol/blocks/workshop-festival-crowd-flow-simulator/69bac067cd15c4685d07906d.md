...
Ahora que tienes funciones para procesar ticks individuales y manejar el desbordamiento, es momento de crear una función controladora para una sola puerta. Esta función manejará todas las acciones de una puerta durante un solo tick de la simulación.
