...
As cores também podem ser representadas por meio de modelos de cor. Eles são essenciais para descrever e reproduzir cores de forma padronizada. Modelos de cor frequentemente usados incluem o modelo RGB, o modelo HSV e o modelo HSL. Eles representam as cores com base em diferentes propriedades. Você aprenderá mais sobre eles em lições futuras.
