...
- Quando o usuário confirma o valor de outra forma, como ao pressionar <kbd>Enter</kbd> depois de digitar algum texto.
...
Apenas quando o usuário pressiona a tecla <kbd>Enter</kbd>.
