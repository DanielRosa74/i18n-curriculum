...
En este código, incluso después de que `createLargeArray` termina de ejecutarse, `largeArray` no puede ser recolectado por el garbage collector porque la función devuelta todavía tiene acceso a él. Esto es un closure, y aunque los closures son útiles, a veces pueden provocar un uso de memoria mayor del que podrías esperar. Aprenderás más sobre closures en lecciones futuras.
