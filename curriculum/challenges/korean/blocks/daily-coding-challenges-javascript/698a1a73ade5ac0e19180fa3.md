...
`"The string has X letters and Y numbers."`를 반환하세요. 여기서 `"X"`는 문자의 개수이고 `"Y"`는 숫자의 개수입니다. 둘 중 하나라도 개수가 1이면, 해당 항목은 단수형을 사용하세요. 예를 들어 `"1 letters"` 대신 `"1 letter"`을, `"1 number"` 대신 `"1 numbers"`를 사용합니다.
