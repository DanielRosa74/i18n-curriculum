...
A fração contínua infinita pode ser escrita como $\\sqrt{2} = \[1; (2)]$, indicando que o 2 se repete *ad infinitum*. De forma semelhante, $\\sqrt{23} = \[4; (1, 3, 1, 8)]$. Acontece que a sequência de valores parciais das frações contínuas para raízes quadradas fornece as melhores aproximações racionais. Vamos considerar os convergentes para $\\sqrt{2}$.
