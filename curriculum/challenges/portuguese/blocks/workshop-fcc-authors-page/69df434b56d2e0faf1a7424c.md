...
Sua variável `initialFetch` deve ser uma função.
...
Sua variável `initialFetch` deve ser uma função assíncrona.
...
Sua função `initialFetch` deve usar a sintaxe de arrow function.
