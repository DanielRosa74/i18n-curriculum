...
Frequentemente, você pode adicionar `-ly` a um adjetivo para transformá-lo em um advérbio. Advérbios são palavras que indicam como algo é dito ou feito. Então, quando você adiciona `-ly` a `actual`, obtém `actually`, que é um advérbio.
