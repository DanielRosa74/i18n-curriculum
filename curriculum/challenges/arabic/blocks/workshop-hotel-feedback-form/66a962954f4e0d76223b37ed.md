...
أسفل ذلك الـ `input`، أضف عنصر `label` بالنص `Location` وبخاصية `for` مضبوطة على `"location"`.

أسفل ذلك العنصر `label`، أضف مربع اختيار `input` آخر مع تعيين خاصيتي `id` و `value` إلى `"reputation"`، وخاصية `name` إلى `"choice"`.

أسفل ذلك الـ `input`، أضف عنصر `label` بالنص `Reputation` وبخاصية `for` مضبوطة على `"reputation"`.
...
يجب أن يحتوي مربع اختيار الـ `input` الرابع على خاصية `id` مضبوطة على `"reputation"`.
