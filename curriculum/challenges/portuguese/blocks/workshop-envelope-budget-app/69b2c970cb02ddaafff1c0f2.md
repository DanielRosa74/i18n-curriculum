...
Em regex, classes de caracteres abreviadas permitem que você combine caracteres específicos sem precisar escrever esses caracteres no seu padrão.

Classes de caracteres abreviadas são precedidas por uma barra invertida (`\`). A classe de caracteres `\s` vai combinar qualquer caractere de espaço em branco. Adicione isso ao final do seu padrão regex.
