...
داخل عنصر `div`، أضف عنصرين `p`. عيّن نص العنصر الثاني `p` ليكون علامة الدولار متبوعة بقيمة المتغير `price`.
...
يجب أن يحتوي العنصر الثاني `p` على علامة الدولار متبوعة بقيمة المتغير `price`.
