...
Em inglês, o dia é dividido em dois períodos usando `AM` e `PM`. `AM` significa `Ante Meridiem`, que é latim para "antes do meio-dia". Refere-se ao período da meia-noite (`12:00 AM`) até o meio-dia (`12:00 PM`). Então, quando você diz `9:00 AM`, significa 9 da manhã.
