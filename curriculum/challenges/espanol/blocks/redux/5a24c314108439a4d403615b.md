...
Los últimos desafíos trabajaron con arreglos, pero también hay formas de ayudar a mantener la inmutabilidad del estado cuando el estado es un `object`. Una herramienta útil para manejar objetos es la utilidad `Object.assign()`. `Object.assign()` toma un objeto objetivo y objetos fuente y asigna propiedades de los objetos fuente al objeto objetivo. Cualquier propiedad coincidente es sobrescrita por las propiedades de los objetos fuente. Este comportamiento se usa comúnmente para hacer copias superficiales de objetos pasando un objeto vacío como primer argumento seguido por el/los objeto(s) que quieres copiar. Aquí tienes un ejemplo:
