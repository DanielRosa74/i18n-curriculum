...
استمر في النمط، وأنشئ مجموعة حقول (`fieldset`) لـ `utilities` مع نفس العناصر المسكنة.
...
يجب أن يحتوي عنصر مجموعة الحقول (`fieldset`) الثالث على معرف (`id`) مضبوط على `utilities`.
...
يجب أن يحتوي عنصر `legend` الجديد على النص `Utilities`.
