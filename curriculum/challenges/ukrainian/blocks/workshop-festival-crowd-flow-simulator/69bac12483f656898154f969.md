...
Ви повинні пройтися циклом по кожній властивості в об’єкті `summary` і вивести наступне повідомлення один раз для кожної властивості: `gate + ": " + summary[gate] + " attendees processed"`.
