...
Ihr anderer Bug tritt auf, wenn Sie einen `Food`-Eintrag hinzufügen, ihn ausfüllen und dann einen zweiten `Food`-Eintrag hinzufügen. Sie werden sehen, dass die von Ihnen eingegebenen Werte verschwunden sind.
