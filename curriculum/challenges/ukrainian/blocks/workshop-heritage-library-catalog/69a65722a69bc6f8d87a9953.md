...
Ви повинні оголосити змінну `const` з ім’ям `header` зі значенням `"Title,Author,Year,Location"`.
...
Ви повинні оголосити змінну `const` з ім’ям `rows`, встановлену як порожній масив.
