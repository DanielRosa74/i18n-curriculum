...
Ваша `handleGateAtTick` функція спочатку має вивести в консоль таке повідомлення: `"\nProcessing " + gate.id + "..."`.
...
Ваша `handleGateAtTick` функція має виводити правильний `id` воріт у повідомленні.
