...
Створіть три нові `li` елементи всередині вашого `ul` елемента з `className` рівним `sub-menu`.

# --hints--

Ви повинні створити три нові `li` елементи всередині вашого `ul` елемента з `className` рівним `sub-menu`.
