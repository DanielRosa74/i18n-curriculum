...
Ao projetar suas aplicações, você frequentemente terá uma série de pequenas funções responsáveis por uma única tarefa. Isso é conhecido como o "princípio da responsabilidade única". Quando você tem uma série de pequenas funções, o ideal é testá-las para garantir que tudo funcione como esperado. Nesta lição, vamos ver como criar um teste unitário usando o popular framework de testes Jest.
