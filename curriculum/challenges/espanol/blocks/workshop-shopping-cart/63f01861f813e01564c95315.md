...
Dentro de tu `div`, agrega dos elementos `p`. Establece el texto del segundo elemento `p` para que sea un signo de dólar seguido del valor de la variable `price`.
...
Tu segundo elemento `p` debe tener un signo de dólar seguido del valor de la variable `price`.
