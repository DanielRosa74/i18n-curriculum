...
Nesta lição, cobrimos apenas algumas das formas de formatar datas em JavaScript. Existem muitos outros métodos e bibliotecas disponíveis para ajudar você a formatar datas em JavaScript. Mas os métodos `toISOString()` e `toLocaleDateString()` são um bom ponto de partida para formatar datas em JavaScript.
