...
Primero, abramos las herramientas para desarrolladores presionando <kbd>F12</kbd> o haciendo clic derecho y seleccionando "Inspeccionar".
...
Primero, abriríamos las herramientas para desarrolladores de Chrome. Lo haríamos, una vez más, abriendo Google Chrome, navegando a una página web que queramos analizar y presionando <kbd>F12</kbd> o haciendo clic derecho en la página y seleccionando "Inspeccionar". Ahora, vamos a la pestaña "Rendimiento" — ahí está todo lo que necesitas.
...
Presionando <kbd>F12</kbd> o haciendo clic derecho y seleccionando "Inspeccionar".
