...
- **Posicionamento sticky**: Esse tipo de posicionamento funciona como um híbrido entre o posicionamento relativo e o fixo. Inicialmente, o elemento se comporta como se estivesse posicionado relativamente, permanecendo dentro do fluxo do documento. Porém, quando o usuário rola a página e o elemento ultrapassa um certo ponto, ele "gruda" na viewport (geralmente no topo) e passa a se comportar como se estivesse fixo. Isso é ótimo para criar elementos como barras de navegação sticky, que só ficam fixas quando o usuário rola até uma determinada posição.
