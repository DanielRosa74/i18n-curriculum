...
- `get_amount_inside`: Recebe outra forma (quadrado ou retângulo) como argumento. Retorna o número de vezes que a forma passada pode caber dentro da forma (sem rotações). Por exemplo, um retângulo com largura 4 e altura 8 pode conter dois quadrados com lados 4.
