...
첫 번째 `h2` 안에 클래스 `box`가 있는 `div` 요소가 텍스트 `Box 1`를 포함하고 있어야 합니다.
...
두 번째 `h2` 안에 클래스 `box`가 있는 `div` 요소가 텍스트 `Box 2`를 포함하고 있어야 합니다.
...
세 번째 `h2` 안에 클래스 `box`가 있는 `div` 요소가 텍스트 `Box 3`를 포함하고 있어야 합니다.
...
네 번째 `h2` 안에 클래스 `box`가 있는 `div` 요소가 텍스트 `Box 4`를 포함하고 있어야 합니다.
...
다섯 번째 `h2` 안에 클래스 `box`가 있는 `div` 요소가 텍스트 `Box 5`를 포함하고 있어야 합니다.
...
마지막 `h2` 안에 클래스 `box`가 있는 `div` 요소가 텍스트 `Box 6`를 포함하고 있어야 합니다.
