...
Declare uma função `checkForStraights` que aceite um array de números. Se o usuário conseguir um large straight, atualize o quinto botão de rádio com uma pontuação de `40`. Se o usuário conseguir um small straight, atualize o quarto botão de rádio com uma pontuação de `30`. Independentemente disso, sempre deve atualizar o último botão de rádio para exibir uma pontuação de 0, com os atributos corretos.
