...
لمشاريع تطوير الويب، لديك خياران. يمكنك استخدام عنصر `link` أو `@import`. إذا اخترت خيار عنصر `link`، يمكنك نسخ ولصق مقتطف HTML وقواعد CSS لإضافتها إلى مشروعك. يجب تضمين الكود في عنصر `head` داخل ملف HTML الخاص بك وإضافة قواعد CSS التي تناسب احتياجاتك.
