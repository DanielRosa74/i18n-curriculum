...
باستخدام نفس صيغة الاستيفاء، أضف عنصر `p` ثانيًا يحتوي على النص `$${expenses} Total Expenses` أسفل عنصر `p` الموجود.

# --hints--

يجب أن تضيف عنصر `p` ثانيًا أسفل العنصر الموجود.
...
يجب أن يحتوي عنصر `p` الثاني على النص `$${expenses} Total Expenses`.
