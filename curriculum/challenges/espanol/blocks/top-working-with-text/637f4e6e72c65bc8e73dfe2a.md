...
El elemento `em` pone el texto en cursiva. También coloca semánticamente énfasis en el texto, lo que puede afectar cosas como los lectores de pantalla. Para definir un elemento enfatizado, se envuelve el contenido de texto en una etiqueta `<em>`.
