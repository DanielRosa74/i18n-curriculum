...
No navegador, o texto e a sombra vão parecer semelhantes.

## Adicionando uma cor à sombra

Também podemos personalizar a cor da sombra especificando o valor antes ou depois do offset. Vamos definir a cor da sombra. Usaremos uma cor hexadecimal aqui, mas você pode usar qualquer formato de cor válido.
...
No navegador, a sombra terá uma cor específica, então podemos distingui-la muito facilmente do texto.

## Valores de offset positivos e negativos

Agora que podemos diferenciar a sombra do texto, também é importante ver como valores positivos e negativos afetam o offset da sombra. Valores positivos do offset `X` e do offset `Y` vão mover a sombra para a direita e para baixo, respectivamente, enquanto valores negativos vão mover a sombra para a esquerda e para cima. Aqui está um exemplo que usa valores negativos em vez disso:
...
Agora a sombra vai se mover para a esquerda e para cima em relação ao texto. Ótimo.
