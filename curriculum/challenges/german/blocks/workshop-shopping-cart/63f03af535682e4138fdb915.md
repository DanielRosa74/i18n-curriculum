...
Setzen Sie den `textContent` des Elements `totalNumberOfItems` auf `0` und den `textContent` der Elemente `cartSubTotal`, `cartTaxes` und `cartTotal` auf `"$0"`.
...
Sie sollten den `textContent` des Elements `cartSubTotal` auf `"$0"` setzen.
...
Sie sollten den `textContent` des Elements `cartTaxes` auf `"$0"` setzen.
...
Sie sollten den `textContent` des Elements `cartTotal` auf `"$0"` setzen.
