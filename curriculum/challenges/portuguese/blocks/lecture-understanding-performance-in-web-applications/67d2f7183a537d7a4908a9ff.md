...
Em seguida, precisamos minimizar as requisições HTTP. Cada arquivo que seu site requisita aumenta o tempo de carregamento. Reduzir o número de requisições HTTP pode levar a carregamentos de página mais rápidos. Você pode:
