...
La tua variabile `displayAuthors` dovrebbe essere una funzione.
...
La tua funzione `displayAuthors` dovrebbe aggiungere una scheda per ogni autore all'elemento `authorContainer`.
