...
Como você lembra das lições anteriores, pode usar o método `map()` para iterar através dos diferentes objetos e renderizar os componentes dinamicamente assim:
