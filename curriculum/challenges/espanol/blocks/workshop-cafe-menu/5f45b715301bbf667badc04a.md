...
El espacio sobre el texto del menú `CAMPER CAFE` no coincide con el espacio debajo de la dirección en la parte inferior del menú. Esto se debe a que el navegador tiene un margen superior predeterminado para el elemento `h1`.
