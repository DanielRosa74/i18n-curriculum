...
Neste exemplo, estamos usando propriedades como `position`, `clip` e `white-space`, que você aprenderá em lições futuras. Por enquanto, saiba que essa regra CSS esconde o conteúdo visualmente enquanto o mantém acessível para leitores de tela. É útil para fornecer contexto adicional aos usuários de leitores de tela sem afetar o layout visual.
