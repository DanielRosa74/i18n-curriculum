...
Una fuente externa es un archivo de fuente que no está incluido directamente dentro de los archivos de tu proyecto. Por lo general, están alojadas en un servidor separado. Un servidor es una computadora que proporciona datos o servicios a otras computadoras a través de una red. Aprenderás más sobre servidores en lecciones futuras. Las fuentes externas te dan más flexibilidad porque puedes usar fuentes personalizadas que tal vez no estén instaladas en el dispositivo del usuario.
