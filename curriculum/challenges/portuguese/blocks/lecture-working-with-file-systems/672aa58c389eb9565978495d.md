...
Para encontrar o File Explorer, você pode ir ao menu Iniciar ou pressionar a tecla <kbd>Windows logo key</kbd> no seu teclado.
...
Pressione <kbd>Command</kbd> + Find.
