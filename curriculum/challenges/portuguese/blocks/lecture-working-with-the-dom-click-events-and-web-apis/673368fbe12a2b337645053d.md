...
Você também provavelmente vai encontrar o método `stopPropagation()`. Esse método impede que o evento suba ou se propague para os elementos pai. Você vai aprender mais sobre o que isso significa em uma lição futura.
