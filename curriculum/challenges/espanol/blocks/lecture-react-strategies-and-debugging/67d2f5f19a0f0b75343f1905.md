...
Un gran inconveniente es que todo el código de los componentes del servidor permanece en el servidor y no se envía al navegador. Eso significa que no puedes usar React hooks con ellos, ni tienen acceso a las API web o a los escuchadores de eventos del navegador. Entonces, ¿cómo puedes agregar interactividad?
