...
`At least` é usado quando você quer dizer que a menor quantidade ou número de algo está ok ou é suficiente. É como dizer "não menos que essa quantidade". Por exemplo:
