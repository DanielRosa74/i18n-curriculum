...
Ahora agrega la edad del estudiante a los datos de la boleta de calificaciones. Para eso, usarás un entero, uno de los tipos de datos numéricos en Python.
