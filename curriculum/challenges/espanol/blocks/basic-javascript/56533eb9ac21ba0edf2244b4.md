...
La razón por la que podrías querer usar un tipo de comillas en lugar de otro es si quieres usar ambos en una cadena. Esto puede ocurrir si quieres guardar una conversación en una cadena y que la conversación esté entre comillas. Otro uso sería guardar una etiqueta `<a>` con varios atributos entre comillas, todo dentro de una cadena.
