...
- Cuando el usuario confirma el valor de otra manera, como al presionar <kbd>Enter</kbd> después de escribir algún texto.
...
Solo cuando el usuario presiona la tecla <kbd>Enter</kbd>.
