...
## Combinar dirección y envoltura con `flex-flow`
...
## Alinear elementos a lo largo del eje principal con `justify-content`

Genial. Ahora hablemos de `justify-content`. `justify-content` alinea los elementos hijos a lo largo del eje principal del contenedor flexible. Si asignas el valor `flex-start` a `justify-content`, los elementos flexibles se alinearán al inicio del eje principal. Esto puede ser horizontal o vertical:
...
## Alinear elementos a lo largo del eje transversal con `align-items`
...
## Sobrescribir la alineación para un solo elemento con `align-self`
