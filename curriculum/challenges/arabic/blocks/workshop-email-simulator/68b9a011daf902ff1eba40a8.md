...
يجب ألا يحتوي كودك على `alice = User("Alice")`.
...
يجب ألا يحتوي كودك على `bob = User("Bob")`.
...
يجب ألا يحتوي كودك على `alice.send_email(bob, "Hello", "Hi Bob, how are you?")`.
...
يجب ألا يحتوي كودك على `print(len(bob.inbox.emails))`.
