...
ابنِ تطبيق JavaScript متكامل الوظائف يشبه هذا: <a href="https://exercise-tracker.freecodecamp.rocks" target="_blank" rel="noopener noreferrer nofollow">https://exercise-tracker.freecodecamp.rocks</a>. يتطلب العمل على هذا المشروع كتابة كودك باستخدام إحدى الطرق التالية:
