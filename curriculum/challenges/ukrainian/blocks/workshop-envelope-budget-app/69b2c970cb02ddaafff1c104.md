...
Ваш наступний крок — дозволити користувачам додавати записи до бюджетного конверта. Оголосіть порожню функцію `addEntry`. Ця функція не повинна приймати жодних параметрів.
