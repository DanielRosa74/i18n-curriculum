...
**Nota:** né `normalizeUnits`, né `validateManifest`, né `processManifest` dovrebbero essere dichiarate usando `const`, poiché i test devono poterle riassegnare.
...
Né `normalizeUnits`, né `validateManifest`, né `processManifest` dovrebbero essere dichiarate usando `const`, poiché i test devono poterle riassegnare.
