...
Використовуючи той самий синтаксис інтерполяції, додайте другий `p` елемент із текстом `$${expenses} Total Expenses` під існуючим `p` елементом.

# --hints--

Ви повинні додати другий `p` елемент під існуючим.
...
Ваш другий `p` елемент має містити текст `$${expenses} Total Expenses`.
