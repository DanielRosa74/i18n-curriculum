...
Esses tipos especiais de entradas dependem de pseudo-elementos complexos para criar coisas como os seletores de data e cor. Isso apresenta um desafio significativo para estilizar essas entradas. Um desafio é que, como a estilização padrão depende totalmente do navegador, o CSS que faz o seletor parecer correto em um navegador pode produzir um resultado muito diferente em outro.
