...
Todas as tabelas em um banco de dados relacional têm uma chave primária, que é um identificador único para cada linha. Elas habilitam relacionamentos entre tabelas por meio de chaves estrangeiras. Você vai aprender mais sobre chaves primárias, chaves estrangeiras e como elas funcionam nas próximas lições. Por enquanto, saiba que elas são fundamentais para conectar registros entre tabelas.
