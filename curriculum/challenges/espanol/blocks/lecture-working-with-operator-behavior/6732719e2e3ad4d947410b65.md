...
Sin seguir esta regla, las ecuaciones básicas te darían una respuesta incorrecta. JavaScript funciona igual. Tiene sus propias reglas para qué operadores van primero, segundo y así sucesivamente.

## Precedencia en expresiones aritméticas

### Precedencia de la multiplicación

Por ejemplo, mira la expresión a continuación:
...
### Usar paréntesis para sobrescribir la precedencia

A veces, puedes querer que ciertas partes de tu expresión se ejecuten primero, sin importar las reglas de precedencia. Puedes usar paréntesis, `()`, para hacer esto. Todo lo que esté dentro de paréntesis se evalúa primero, sin importar qué. Hagamos que la parte `2 + 3` del ejemplo de multiplicación se evalúe primero:
