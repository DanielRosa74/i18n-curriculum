...
`searchValue` es el valor que quieres buscar en la cadena. Puede ser una cadena o una expresión regular (regex), que describe patrones en el texto. Esto te permite buscar y manipular cadenas de manera flexible y poderosa. Aprenderás más sobre expresiones regulares en lecciones futuras.
