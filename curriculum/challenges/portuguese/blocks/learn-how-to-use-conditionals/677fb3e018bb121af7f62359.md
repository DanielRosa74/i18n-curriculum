...
O `First Conditional` é usado para descrever situações reais e possíveis no futuro. Ele é formado por `if` + `Present Simple` (para a condição) e `will` + verbo base (para o resultado). Por exemplo:
