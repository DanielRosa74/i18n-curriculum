...
Sie sollten jede Eigenschaft im `summary`-Objekt durchlaufen und für jede Eigenschaft die folgende Nachricht protokollieren: `gate + ": " + summary[gate] + " attendees processed"`.
