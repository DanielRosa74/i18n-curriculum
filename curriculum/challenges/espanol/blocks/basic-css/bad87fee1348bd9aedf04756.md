...
Sin embargo, lo que importa es el orden de las declaraciones de `class` en la sección `<style>`. La segunda declaración siempre tendrá prioridad sobre la primera. Como `.blue-text` se declara en segundo lugar, sobrescribe los atributos de `.pink-text`.
