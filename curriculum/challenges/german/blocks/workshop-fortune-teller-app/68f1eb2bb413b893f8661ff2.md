...
Rufen Sie innerhalb der `newReading`-Methode `showElements` auf und übergeben Sie `this.elements.singleCardBtn`, `this.elements.multipleCardsBtn` und `this.elements.headerTitle` als Argumente.

Rufen Sie dann `hideElements` auf und übergeben Sie `this.elements.singleCard`, `this.elements.multipleCard`, `this.elements.fortuneContainer` und `this.elements.fortuneDescription` als Argumente.
