...
Além da primeira opção vazia, o elemento `select` deve conter 6 elementos `option`, um para cada uma das seguintes cidades: Paris, Londres, Tóquio, Los Angeles, Chicago, Nova York.
