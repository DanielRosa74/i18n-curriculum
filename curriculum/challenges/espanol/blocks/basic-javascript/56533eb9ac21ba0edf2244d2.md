...
El operador de desigualdad (`!=`) es el opuesto del operador de igualdad. Desigualdad significa no igual. El operador de desigualdad devuelve `false` cuando el operador de igualdad devolvería `true` y *viceversa*. Al igual que el operador de igualdad, el operador de desigualdad convierte los tipos de datos de los valores al comparar.
