...
QuickTimeはAppleが作成した拡張可能なマルチメディアアーキテクチャで、さまざまなデジタルメディアフォーマットの再生、ストリーミング、エンコード、トランスコーディングをサポートしています。MP4フォーマットほど一般的ではありませんが、レガシーアプリケーションのサポートに必要になる場合があります。
