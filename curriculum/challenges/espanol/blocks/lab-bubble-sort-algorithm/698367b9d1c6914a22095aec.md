...
Para este laboratorio, implementarás el algoritmo de ordenamiento burbuja. Comienza al inicio de un arreglo desordenado y "hace subir" los valores desordenados hacia el final, iterando a través del arreglo hasta que esté completamente ordenado. Lo hace comparando elementos adyacentes y cambiándolos de lugar si están fuera de orden. El método continúa recorriendo el arreglo hasta que no se realicen intercambios, momento en el que el arreglo está ordenado.
