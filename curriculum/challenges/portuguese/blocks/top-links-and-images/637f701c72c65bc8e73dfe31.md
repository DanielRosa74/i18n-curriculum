...
Para exibir uma imagem em HTML você usa o elemento `<img>`. Diferente dos outros elementos que você encontrou, o `<img>` é um elemento vazio. Elementos HTML vazios não precisam de uma tag de fechamento.
