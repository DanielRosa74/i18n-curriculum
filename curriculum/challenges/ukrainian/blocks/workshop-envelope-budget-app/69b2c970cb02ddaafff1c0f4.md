...
Регулярний вираз також може приймати певні прапорці, щоб змінити поведінку пошуку за шаблоном. Прапорці додають після закриваючого `/`. Прапорець `g`, що означає «глобальний», вкаже шаблону продовжувати пошук після того, як він знайшов співпадіння. Ось приклад:
