...
Para usar Lighthouse, abre tus herramientas para desarrolladores presionando <kbd>F12</kbd> y cambia a la pestaña Lighthouse.
Selecciona las métricas que quieres revisar, elige el dispositivo en el que quieres probar y haz clic en el botón "Analizar carga de página".
...
Para usar el IBM Accessibility Checker como extensión de Chrome, descárgalo desde la tienda web de Chrome. Abre tus herramientas para desarrolladores presionando <kbd>F12</kbd> y selecciona la pestaña "Accessibility Checker" ubicada en el panel de elementos. Haz clic en el botón de escanear para iniciar la revisión y se generará un informe para ti. Puedes exportar el informe como hoja de cálculo y archivo HTML haciendo clic en el botón "Export XLS".
