...
Primeiro, vamos abrir as ferramentas de desenvolvimento pressionando <kbd>F12</kbd> ou clicando com o botão direito e selecionando "Inspecionar".
...
Primeiro, abriríamos as ferramentas de desenvolvimento do Chrome. Faremos isso, mais uma vez, abrindo o Google Chrome, navegando até uma página que queremos analisar e pressionando <kbd>F12</kbd> ou clicando com o botão direito na página e selecionando "Inspecionar". Agora, vamos para a aba "Performance" — lá está tudo que você precisa.
...
Pressionando <kbd>F12</kbd> ou clicando com o botão direito e selecionando "Inspecionar".
