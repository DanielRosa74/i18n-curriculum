...
在 `newReading` 方法中，呼叫 `showElements`，並將 `this.elements.singleCardBtn`、`this.elements.multipleCardsBtn` 和 `this.elements.headerTitle` 作為引數傳入。

接著呼叫 `hideElements`，並將 `this.elements.singleCard`、`this.elements.multipleCard`、`this.elements.fortuneContainer` 和 `this.elements.fortuneDescription` 作為引數傳入。
