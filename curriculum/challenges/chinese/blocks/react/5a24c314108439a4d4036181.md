...
还有其他复杂的概念可以为你的 React 代码添加强大功能。但你可能会想知道如何为你在 React 中创建的那些 JSX 元素设置样式这个更简单的问题。你可能知道这不会完全像操作 HTML 那样，因为<a href="/learn/front-end-development-libraries/react/define-an-html-class-in-jsx" target="_blank" rel="noopener noreferrer nofollow">你为 JSX 元素应用类的方式</a>不同。
