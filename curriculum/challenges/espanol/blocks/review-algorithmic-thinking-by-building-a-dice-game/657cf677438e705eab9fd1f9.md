...
Si lanzas los dados y obtienes un `Three of a kind` o un `Four of a kind`, entonces puedes obtener una puntuación que suma el total de los valores de los cinco dados. Para calcular esto, crea una función `getHighestDuplicates` que reciba un arreglo de números. La función deberá contar cuántas veces aparece cada número en el arreglo.
