...
`We can` é usado para sugerir uma ideia ou propor algo de forma educada. Isso mostra que as pessoas na conversa têm a habilidade ou a opção de fazer algo. Por exemplo: se você quiser sugerir jogar um jogo, pode dizer `We can play a game` para oferecer a ideia.
