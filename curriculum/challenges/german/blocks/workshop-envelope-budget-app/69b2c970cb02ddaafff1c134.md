...
Erstellen Sie nun ein `p`-Element mit dem Text `$${income} Total Income`, wobei Sie Interpolation verwenden, um income durch die passende Variable zu ersetzen.
...
Ihr `p`-Element sollte den Text `$${income} Total Income` enthalten.
