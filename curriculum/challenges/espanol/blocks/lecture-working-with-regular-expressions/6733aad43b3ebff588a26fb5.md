...
Esta expresión regular en particular coincidirá con el texto `freeCodeCamp`, con las `C` mayúsculas, en cualquier parte de una cadena.

Si tu patrón proviene de una variable en lugar de estar escrito directamente en el literal regex, puedes crear el mismo tipo de expresión regular con el constructor `RegExp`:
...
¿Pero cómo puedes usar realmente una expresión regular?

## Probar una cadena con `test()`
...
## Obtener detalles de la coincidencia con `match()`
