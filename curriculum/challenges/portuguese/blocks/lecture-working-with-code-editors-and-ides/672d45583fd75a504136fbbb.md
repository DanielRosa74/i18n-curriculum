...
Para instalar o VS Code, você deve visitar o site do VS Code para obter o instalador apropriado para seu sistema operacional. Certifique-se de visitar o site do VS Code, e não o site do Visual Studio.

Para Windows, você pode baixar um instalador `.exe`. Depois de baixá-lo, execute o arquivo e o assistente de instalação vai guiá-lo pelo processo.

No Mac, você pode baixar um arquivo `.zip`, que contém um `.app` que você pode executar. Você também pode instalar o VS Code via Homebrew.
