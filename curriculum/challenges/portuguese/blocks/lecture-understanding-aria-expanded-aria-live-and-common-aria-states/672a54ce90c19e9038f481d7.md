...
## O que é o atributo `aria-expanded`?
...
## Definindo `aria-expanded` como `true` ou `false`
...
## Conectando o controle ao seu conteúdo
...
### Mantendo `aria-expanded` sincronizado
