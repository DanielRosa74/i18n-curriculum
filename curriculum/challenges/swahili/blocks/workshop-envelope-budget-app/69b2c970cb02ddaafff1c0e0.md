...
Kipengele chako cha `input` cha mapato kinahitaji sifa za kipengele za ziada ili kuhakikisha watumizi wanaingiza thamani halali.

Sahihisha kipengele cha `#income` ulichotengeneza kwa sifa za kipengele zifuatazo:

- `type` iwe imewekwa kuwa `number` (kuruhusu ingizo la nambari tu)
- `min` iwe imewekwa kuwa `0` (kuruhusu nambari chanya tu)
- `placeholder` iwe imewekwa kuwa `e.g. 2000`
- Mwishowe, weka kipengele cha `input` kuwa `required`.
...
Kipengele chako cha `input` kinapaswa kuwa na sifa ya kipengele ya `placeholder` iliyowekwa kuwa `e.g. 2000`.
