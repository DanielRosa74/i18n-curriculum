...
Щоб прапорець `input` був позначений за замовчуванням, ви можете додати атрибут `checked`.
...
Додайте атрибут `checked` до прапорця `input` з `id` `"reputation"`, щоб він був позначений за замовчуванням.

# --hints--

Вашому прапорцю `input` з `id` `"reputation"` слід додати атрибут `checked`.
