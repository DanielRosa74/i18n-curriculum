...
- **Páginas del manual**: Usa `man` para acceder a documentación detallada de los comandos.
  - Proporciona información completa sobre el uso del comando
  - Muestra todas las opciones disponibles y ejemplos
  - Usa <kbd>teclas de flecha</kbd> para navegar, <kbd>q</kbd> para salir
  - No todos los comandos tienen páginas del manual (los integrados usan `help` en su lugar)
