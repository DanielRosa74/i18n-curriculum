...
Usando la stessa sintassi di interpolazione, aggiungi un secondo elemento `p` con il testo `$${expenses} Total Expenses` sotto l'elemento `p` esistente.

# --hints--

Dovresti aggiungere un secondo elemento `p` sotto quello esistente.
...
Il tuo secondo elemento `p` dovrebbe avere il testo `$${expenses} Total Expenses`.
