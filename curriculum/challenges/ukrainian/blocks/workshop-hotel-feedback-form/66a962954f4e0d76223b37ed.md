...
Під цим `input` додайте `label` елемент з текстом `Location` та атрибутом `for`, встановленим у `"location"`.
...
Під цим `input` додайте `label` елемент з текстом `Reputation` та атрибутом `for`, встановленим у `"reputation"`.
...
Ваш четвертий прапорець `input` повинен мати атрибут `id`, встановлений у `"reputation"`.
