...
Що створює `repeat(3, minmax(100px, 1fr))`, коли його використовують з `grid-template-columns`?

#### --distractors--

Три колонки, які не можуть бути більшими за `100px`.
...
Змушує починатися з другої лінії рядка.
