...
Ndani ya template literal yako, tengeneza kipengele cha `label` na kipa maandishi `Expense # Name`. Kwa kutumia sintaksia ya template literal yako, badilisha `#` na thamani ya `entryNumber`.
