...
El operador bitwise NOT es un operador unario menos común. Representado por una tilde, `~`, invierte la representación binaria de un número. Las computadoras almacenan números en formato binario (1s y 0s). El operador `~` invierte cada bit, lo que significa que cambia todos los 1s a 0s y todos los 0s a 1s. Aprenderás más sobre binario y bits en una lección futura.
