...
**Nota:** Ni `normalizeUnits`, ni `validateManifest`, ni `processManifest` deben declararse usando `const`, ya que las pruebas necesitan reasignarlos.
...
Ni `normalizeUnits`, ni `validateManifest`, ni `processManifest` deben declararse usando `const`, ya que las pruebas necesitan reasignarlos.
