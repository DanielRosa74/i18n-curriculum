...
`console.log()` 문 안에 첫 번째 인수로 `"Author Data Array:"` 텍스트를, 두 번째 인수로 `authorDataArr`를 추가하세요. 텍스트와 `authorDataArr`는 쉼표로 구분하세요.
...
`authorDataArr`는 `console.log()` 문에서 두 번째 인수여야 합니다.
