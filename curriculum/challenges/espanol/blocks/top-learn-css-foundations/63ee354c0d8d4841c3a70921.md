...
Puede volverse bastante desordenado rápidamente una vez que comienzas a agregar muchas declaraciones a un solo elemento, haciendo que tu archivo HTML se vuelva innecesariamente pesado.
Si quieres que muchos elementos tengan el mismo estilo, tendrías que copiar y pegar el mismo estilo en cada elemento individual, causando mucha repetición innecesaria y más peso.
Cualquier CSS en línea sobrescribirá los otros dos métodos, lo que puede causar resultados inesperados. (Aunque no profundizarás en esto aquí, en realidad se puede aprovechar).
