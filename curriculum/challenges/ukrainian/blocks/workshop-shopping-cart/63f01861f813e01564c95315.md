...
Всередині вашого `div` додайте два `p` елементи. Встановіть текст другого `p` елемента як знак долара, за яким йде значення змінної `price`.
...
Другий `p` елемент має містити знак долара, за яким йде значення змінної `price`.
