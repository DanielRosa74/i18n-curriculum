...
El siguiente paso es crear una forma para colocar en el área `svg`. Hay varias formas compatibles en SVG, como rectángulos y círculos. Se usan para mostrar datos. Por ejemplo, una forma SVG de rectángulo (`<rect>`) podría crear una barra en un gráfico de barras.
