...
ابدأ بالحصول على عنصر `form` (باستخدام `id`) وتخزينه في متغير يسمى `budgetForm`.

# --hints--

يجب أن تنشئ متغيرًا يسمى `budgetForm`.
...
يجب أن تُعيّن `document.getElementById('budget-form')` إلى متغير `budgetForm`.
