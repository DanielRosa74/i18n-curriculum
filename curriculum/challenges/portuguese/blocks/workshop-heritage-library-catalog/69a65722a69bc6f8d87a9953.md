...
Você deve declarar uma variável `const` chamada `header` com o valor `"Title,Author,Year,Location"`.
...
Você deve declarar uma variável `const` chamada `rows` definida como um array vazio.
