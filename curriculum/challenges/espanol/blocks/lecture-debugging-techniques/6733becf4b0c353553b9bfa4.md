...
JavaScript ejecuta tu código de arriba hacia abajo. Cuando JavaScript ejecuta tu código y encuentra una sentencia `debugger`, detiene inmediatamente la ejecución en esa línea. Esto te da la oportunidad de inspeccionar variables, revisar funciones y el flujo del código en general.
