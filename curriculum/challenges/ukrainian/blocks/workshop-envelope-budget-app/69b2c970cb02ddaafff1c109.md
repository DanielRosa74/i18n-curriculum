...
Кожен запис матиме текстове поле для імені запису та числове поле для бюджету. Щоб отримати кількість записів, ви можете зробити запит за текстовими полями.
