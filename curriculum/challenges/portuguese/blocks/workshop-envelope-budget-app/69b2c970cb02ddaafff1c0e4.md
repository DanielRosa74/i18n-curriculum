...
Você precisa de mais um desses blocos de código `fieldset` para `entertainment`.
...
Seu quarto elemento `fieldset` deve ter um `id` definido como `entertainment`.
...
Seu quarto elemento `legend` deve conter o texto `Entertainment`.
