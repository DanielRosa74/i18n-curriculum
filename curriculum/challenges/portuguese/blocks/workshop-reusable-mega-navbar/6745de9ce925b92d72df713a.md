...
Dentro de cada um dos três novos elementos `li`, crie um elemento `a` com um atributo `href` igual a `#`.

# --hints--

Você deve criar um novo elemento `a` com um atributo `href` igual a `#` dentro de cada um dos três novos elementos `li`.
