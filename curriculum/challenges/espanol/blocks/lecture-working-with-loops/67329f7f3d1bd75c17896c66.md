...
En JavaScript, hay varios tipos de ciclos que puedes usar. En esta lección, cubriremos el ciclo `for`. Aquí está la sintaxis básica para un ciclo `for`:
