...
Como você aprendeu em uma lição anterior, bancos de dados relacionais organizam os dados em tabelas. Cada tabela tem um conjunto de linhas e colunas, onde os atributos dos dados e seus relacionamentos são representados. Cada linha representa um registro enquanto cada coluna representa um atributo ou campo específico desse registro.
