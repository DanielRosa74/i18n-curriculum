...
La función `enumerate()` también acepta un argumento opcional `start` que especifica el valor inicial para el conteo. Si se omite este argumento, el conteo comenzará en `0`. Aquí tienes un ejemplo de cómo usar el argumento opcional `start`:
