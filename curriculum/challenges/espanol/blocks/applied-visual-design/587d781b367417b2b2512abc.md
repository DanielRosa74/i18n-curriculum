...
<blockquote>rgba significa:<br>  r = rojo<br>  g = verde<br>  b = azul<br>  a = alfa/nivel de opacidad</blockquote>

Los valores RGB pueden variar de 0 a 255. El valor alfa puede ir de 1, que es totalmente opaco o un color sólido, a 0, que es totalmente transparente o claro. `rgba()` es ideal para usar en este caso, ya que permite ajustar la opacidad. Esto significa que no tienes que bloquear completamente el fondo.
