...
- El primer párrafo será rojo porque un selector de ID tiene una especificidad mayor que las clases y los selectores de tipo.
- El segundo párrafo con un selector de clase `.example-para` tendrá un color verde.
- El tercer párrafo con un selector de ID `#para-3` y un selector de clase `.example-para` tendrá un color púrpura.
- El párrafo restante tendrá un color azul.
...
## Cálculo de valores de especificidad
