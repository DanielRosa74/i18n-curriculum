...
Remova os três componentes `<Card />` dentro do elemento `<div className="flex-container">`. Nos próximos passos, você vai criar um array de dados e usar o método `map()` para renderizar os componentes `Card`, que é a abordagem mais comum no React.
