...
Коли користувач вводить суми доходів або витрат, поля введення прийматимуть лише числові значення. Однак, якщо число введене з символом `+` або `-`, потрібно буде видалити ці символи.
