...
O elemento `path` precisa ter sua forma definida. É aí que entra o atributo `d`. Ele é usado para criar uma série de letras de comando e números que desenham uma forma.
