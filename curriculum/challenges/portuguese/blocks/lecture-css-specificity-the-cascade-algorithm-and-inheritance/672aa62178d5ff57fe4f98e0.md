...
- O primeiro parágrafo ficará vermelho porque um seletor de ID tem uma especificidade maior que classes e seletores de tipo.
- O segundo parágrafo com um seletor de classe `.example-para` terá a cor verde.
- O terceiro parágrafo com um seletor de ID `#para-3` e um seletor de classe `.example-para` terá a cor roxa.
- O parágrafo restante terá a cor azul.
...
## Calculando valores de especificidade
