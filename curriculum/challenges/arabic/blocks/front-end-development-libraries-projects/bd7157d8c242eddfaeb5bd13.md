...
**قصة المستخدم #5:** عندما يفتح عارض الـ markdown الخاص بي لأول مرة، يجب أن يحتوي النص الافتراضي في حقل `#editor` على markdown صالح يُمثّل على الأقل واحدًا من كل العناصر التالية: عنصر عنوان (بحجم H1)، عنصر عنوان فرعي (بحجم H2)، رابط، كود مضمَّن، كتلة كود، عنصر قائمة، اقتباس، صورة، ونص عريض.
