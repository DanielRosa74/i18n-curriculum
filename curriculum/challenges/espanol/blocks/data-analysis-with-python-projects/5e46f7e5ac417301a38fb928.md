...
Vas a <a href="https://codespaces.new/freeCodeCamp/boilerplate-mean-variance-standard-deviation-calculator/" target="_blank" rel="noopener noreferrer nofollow">trabajar en este proyecto con nuestro código repetitivo inicial</a>.
...
Escribe tu código en `mean_var_std.py`. Para el desarrollo, puedes usar `main.py` para probar tu código.
Para ejecutar tu código, escribe `python3 main.py` en la terminal y presiona enter. Esto hará que el intérprete CPython incluido ejecute el archivo `main.py`.
