...
Ve a tus ajustes, filtra por "Centro de control", haz clic en esta opción y luego desplázate hacia abajo hasta encontrar la opción "Spotlight". También puedes usar un atajo de teclado para abrir Spotlight: <kbd>Command</kbd> + <kbd>Spacebar</kbd>.
...
Otra forma de buscar archivos que has abierto recientemente es abrir Finder haciendo clic en el ícono de Finder en el Dock. Luego, ve a "Recientes" en la barra lateral de Finder. Allí encontrarás todos los archivos que has visto recientemente.
