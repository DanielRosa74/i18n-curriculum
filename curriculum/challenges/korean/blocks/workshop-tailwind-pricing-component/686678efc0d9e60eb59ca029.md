...
텍스트 `Most popular`가 있는 `div` 요소에 `bg-gradient-to-r` 클래스를 추가하세요.
...
텍스트 `Most popular`가 있는 `div` 요소에 `from-fuchsia-500` 클래스를 추가하세요.
...
텍스트 `Most popular`가 있는 `div` 요소에 `to-indigo-500` 클래스를 추가하세요.
...
텍스트 `Most popular`가 있는 `div` 요소에 `rounded-full` 클래스를 추가하세요.
...
텍스트 `Most popular`가 있는 `div` 요소에 `px-3` 클래스를 추가하세요.
...
텍스트 `Most popular`가 있는 `div` 요소에 `py-1` 클래스를 추가하세요.
...
텍스트 `Most popular`가 있는 `div` 요소에 `text-xs` 클래스를 추가하세요.
...
텍스트 `Most popular`가 있는 `div` 요소에 `font-bold` 클래스를 추가하세요.
...
텍스트 `Most popular`가 있는 `div` 요소에 `text-white` 클래스를 추가하세요.
