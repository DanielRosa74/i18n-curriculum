...
Você estará <a href="https://codespaces.new/freeCodeCamp/boilerplate-demographic-data-analyzer/" target="_blank" rel="noopener noreferrer nofollow">trabalhando neste projeto com nosso código inicial</a>.
...
Dua, D. e Graff, C. (2019). <a href="http://archive.ics.uci.edu/ml" target="_blank" rel="noopener noreferrer nofollow">Repositório de aprendizado de máquina UCI</a>. Irvine, CA: Universidade da Califórnia, Escola de Ciência da Informação e Computação.
