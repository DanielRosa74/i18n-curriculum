...
Cuando hagas clic en `#view-category-button`, debes llamar a `displayOrHideCategory` para mostrar la sección de la lista de marcadores y ocultar la sección principal.
