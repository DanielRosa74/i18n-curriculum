...
Dentro de tu literal de plantilla, crea un elemento `label` y asígnale el texto `Expense # Name`. Usando la sintaxis de tu literal de plantilla, reemplaza `#` con el valor de `entryNumber`.
