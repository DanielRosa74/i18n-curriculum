...
你将使用我们的起始代码<a href="https://codespaces.new/freeCodeCamp/boilerplate-mean-variance-standard-deviation-calculator/" target="_blank" rel="noopener noreferrer nofollow">完成这个项目</a>。
...
在 `mean_var_std.py` 中编写你的代码。开发时，你可以使用 `main.py` 来测试你的代码。
要运行你的代码，在终端输入 `python3 main.py` 并按回车。这会让内置的 CPython 解释器运行 `main.py` 文件。
