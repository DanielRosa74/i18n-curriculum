...
Regex kann auch bestimmte Flags annehmen, um das Mustererkennungsverhalten zu ändern. Flags werden nach dem abschließenden `/` hinzugefügt. Das `g`-Flag, das für „global“ steht, weist das Muster an, nach einem Treffer weiterzusuchen. Hier ist ein Beispiel:
