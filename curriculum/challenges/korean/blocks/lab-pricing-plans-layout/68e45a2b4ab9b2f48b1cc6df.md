...
페이지에 텍스트가 `Pricing Plans`인 `h1` 요소가 있어야 합니다.
...
`.basic-plan` 요소에는 텍스트가 `Basic`인 `h2` 요소가 있어야 합니다.
...
`.basic-plan` 요소에는 텍스트가 `$9/month`인 `p` 요소가 있어야 합니다.
...
`.pro-plan` 요소에는 텍스트가 `Pro`인 `h2` 요소가 있어야 합니다.
...
`.pro-plan` 요소에는 텍스트가 `$19/month`인 `p` 요소가 있어야 합니다.
...
`.premium-plan` 요소에는 텍스트가 `Premium`인 `h2` 요소가 있어야 합니다.
...
`.premium-plan` 요소에는 텍스트가 `$29/month`인 `p` 요소가 있어야 합니다.
