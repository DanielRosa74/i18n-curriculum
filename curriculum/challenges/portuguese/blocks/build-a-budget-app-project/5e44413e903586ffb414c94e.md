...
O gráfico deve mostrar a porcentagem gasta em cada categoria passada para a função. A porcentagem gasta deve ser calculada apenas com os saques e não com os depósitos, e deve ser a porcentagem do valor gasto em cada categoria em relação ao total gasto em todas as categorias. Na lateral esquerda do gráfico devem estar os rótulos de 0 a 100. As 'barras' do gráfico de barras devem ser feitas com o caractere 'o'. A altura de cada barra deve ser arredondada para baixo até o múltiplo de 10 mais próximo. A linha horizontal abaixo das barras deve ultrapassar duas posições além da última barra. O nome de cada categoria deve ser escrito verticalmente abaixo da barra. Deve haver um título no topo que diga 'Percentage spent by category'.
