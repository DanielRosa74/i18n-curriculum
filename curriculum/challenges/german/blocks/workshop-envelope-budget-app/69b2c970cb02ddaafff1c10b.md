...
Erstellen Sie innerhalb Ihres Template-Literals ein `label`-Element und geben Sie ihm den Text `Expense # Name`. Ersetzen Sie mit Ihrer Template-Literal-Syntax `#` durch den Wert von `entryNumber`.
