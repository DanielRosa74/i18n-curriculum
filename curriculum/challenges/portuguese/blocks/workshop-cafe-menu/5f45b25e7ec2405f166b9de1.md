...
Altere a cor do link `Visit our website` no rodapé para `gray` quando o usuário tiver visitado o link.
...
Você deve definir a propriedade `color` para `gray`.
...
Seu `a:visited` deve ter a `color` `gray`.
