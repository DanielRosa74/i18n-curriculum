...
Ahora esta relación ordenada es muy fácil de ver. Observa que cada valor a la izquierda del 8, el nodo raíz, es menor que 8, y cada valor a la derecha es mayor que 8. También nota que esta relación se aplica a cada uno de los subárboles. Por ejemplo, el primer hijo izquierdo es un subárbol. 3 es el nodo padre, y tiene exactamente dos nodos hijos: según las reglas que rigen los árboles de búsqueda binaria, sabemos sin siquiera mirar que el hijo izquierdo de este nodo (y cualquiera de sus hijos) será menor que 3, y el hijo derecho (y cualquiera de sus hijos) será mayor que 3 (pero también menor que el valor raíz de la estructura), y así sucesivamente.
