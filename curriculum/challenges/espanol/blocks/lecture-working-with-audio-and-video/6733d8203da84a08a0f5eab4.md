...
Un archivo MP3 tiene el tipo MIME `audio/mpeg`. Un MP4, sin embargo, puede tener el tipo MIME `audio/mp4` O `video/mp4`, dependiendo de si es un archivo de video o solo de audio. Esta distinción indica al navegador cómo manejar el archivo.
