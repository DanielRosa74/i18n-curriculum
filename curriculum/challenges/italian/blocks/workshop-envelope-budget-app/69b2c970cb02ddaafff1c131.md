...
Devi costruire la stringa HTML che sarà mostrata nell'elemento `output`.

Inizia assegnando un letterale template vuoto alla proprietà `innerHTML` dell'elemento `output` in una nuova riga alla fine dell'istruzione `if`.
