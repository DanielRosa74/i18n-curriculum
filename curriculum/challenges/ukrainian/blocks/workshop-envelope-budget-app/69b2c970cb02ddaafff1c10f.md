...
Нарешті, на новому рядку після вашої другої `label` створіть ще один елемент `input`. Додайте цьому елементу атрибут `type` зі значенням `number`, атрибут `min`, встановлений у `0` (щоб не можна було додати від’ємні значення), атрибут `placeholder` зі значенням `Amount` і атрибут `id`, який співпадає з атрибутом `for` вашої другої мітки `label`.
...
Ваш `input` елемент повинен мати атрибут `placeholder`, встановлений у `Amount`.
...
Ваш `input` елемент повинен мати атрибут `id`, встановлений у `${category}-${entryNumber}-amount`.
...
Ваш новий `input` елемент повинен мати атрибут `min`, встановлений у `0`.
