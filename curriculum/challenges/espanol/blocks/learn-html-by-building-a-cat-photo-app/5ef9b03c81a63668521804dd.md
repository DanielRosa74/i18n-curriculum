...
El texto ` Indoor` debe estar ubicado directamente a la derecha de tu botón `radio`. Asegúrate de que haya un espacio entre el elemento y el texto. O has omitido el texto o tienes un error tipográfico.
