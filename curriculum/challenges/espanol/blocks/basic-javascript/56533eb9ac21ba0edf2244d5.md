...
El operador mayor o igual que (`>=`) compara los valores de dos números. Si el número a la izquierda es mayor o igual que el número a la derecha, devuelve `true`. De lo contrario, devuelve `false`.
