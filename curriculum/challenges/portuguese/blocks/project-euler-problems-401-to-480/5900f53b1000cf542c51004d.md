...
Encontre $F({10}^{18})$. Dê sua resposta como uma string em notação científica arredondada para dez dígitos após o ponto decimal. Ao fornecer sua resposta, use um `e` minúsculo para separar a mantissa do expoente. Por exemplo, se a resposta for $112\\,233\\,445\\,566\\,778\\,899$, o formato da resposta seria `1.1223344557e17`.
