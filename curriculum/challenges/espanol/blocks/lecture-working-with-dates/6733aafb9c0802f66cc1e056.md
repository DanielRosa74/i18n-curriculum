...
## Crear una fecha con un valor específico

Aquí tienes un ejemplo de cómo crear un nuevo objeto `Date` con una cadena de fecha específica:
...
También puedes pasar una fecha y hora específicas al objeto `Date` proporcionando los valores de año, mes, día, hora, minuto, segundo y milisegundo como argumentos:
...
Esto es útil cuando necesitas trabajar con una fecha y hora específicas en lugar de la fecha y hora actuales.

## Obtener la hora actual con `Date.now()`
