...
## Mantendo o carrinho visível

Nesta lição, vamos discutir algumas melhores práticas para projetar carrinhos de compras. A primeira consideração de design é garantir que o carrinho de compras esteja visível para os usuários o tempo todo. A maioria dos designs de carrinho de compras exibe o carrinho no canto superior direito da página. Os usuários devem ver o número de itens no carrinho exibido ao lado do ícone do carrinho e poder clicar no carrinho para ver mais detalhes sobre os itens que estão comprando.
...
## Gerenciando a quantidade e remoção de itens
...
## Escolhendo um ícone de carrinho reconhecível
...
## Adicionando um call-to-action para finalizar a compra
