...
Vamos começar com as ferramentas de desenvolvimento do navegador, comumente conhecidas como DevTools. A maioria dos navegadores modernos, incluindo Chrome, Firefox e Safari, já vem com DevTools embutido. Para acessá-las, você pode clicar com o botão direito em um elemento da sua página e selecionar "Inspecionar" ou usar atalhos de teclado como <kbd>F12</kbd> ou <kbd>Cmd</kbd> + <kbd>Option</kbd> + <kbd>I</kbd> (no macOS).
