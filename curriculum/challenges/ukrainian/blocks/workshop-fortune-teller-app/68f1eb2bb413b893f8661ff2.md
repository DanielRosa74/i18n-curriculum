...
У методі `newReading` викличте `showElements` і передайте як аргументи `this.elements.singleCardBtn`, `this.elements.multipleCardsBtn` та `this.elements.headerTitle`.

Потім викличте `hideElements` і передайте як аргументи `this.elements.singleCard`, `this.elements.multipleCard`, `this.elements.fortuneContainer` та `this.elements.fortuneDescription`.
