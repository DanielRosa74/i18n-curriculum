...
값이 `https://cdn.freecodecamp.org/curriculum/js-music-player/can't-stay-down.mp3` 인 `src` 속성을 추가하세요.
...
`audio` 요소에 값이 `https://cdn.freecodecamp.org/curriculum/js-music-player/can't-stay-down.mp3` 인 `src` 속성이 있어야 합니다.
