...
أظهر التحدي الأخير مثالًا على خاصية `justify-content`. في تضمين التغريدة، يمكن تطبيق هذه الخاصية لمحاذاة العناصر داخل عنصر `.profile-name`.

# --instructions--

أضف خاصية CSS `justify-content` إلى عنصر `.profile-name` في القسم العلوي واضبط القيمة على أي من الخيارات الموجودة في التحدي الأخير.
