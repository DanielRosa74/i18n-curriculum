...
- **Introdução**: Python é uma linguagem de tipagem dinâmica, o que significa que você não precisa declarar o tipo de dado de uma variável. Python determina o tipo a partir do valor atribuído à variável.
