...
Crie outro elemento `a` dentro do seu segundo elemento `li`. Dê a ele um atributo `href` com o valor `#` e o texto `Widgets`.

# --hints--

Você deve criar um elemento `a` dentro do seu segundo elemento `li`.
