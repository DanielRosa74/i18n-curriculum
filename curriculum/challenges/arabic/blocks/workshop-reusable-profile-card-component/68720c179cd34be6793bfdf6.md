...
احذف ثلاثة مكوِّنات `<Card />` داخل عنصر `<div className="flex-container">`. في الخطوات التالية، ستُنشئ مصفوفة من البيانات وتستخدم الطريقة `map()` لعرض مكوِّنات `Card`، وهي الطريقة الأكثر شيوعًا في React.

# --hints--

يجب إزالة ثلاثة مكوِّنات `<Card />` من الكود الخاص بك.
