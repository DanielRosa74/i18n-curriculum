...
Como aprendiste en lecciones anteriores, una función callback es una función que pasas a otra función para que se llame más tarde. Los manejadores de eventos son un tipo particular de callback con los que ya has trabajado. Solían ser la forma más común de implementar funciones asíncronas en JavaScript. Sin embargo, si la función callback también recibe otras funciones callback, el código y la lógica pueden volverse bastante complicados muy rápido.
