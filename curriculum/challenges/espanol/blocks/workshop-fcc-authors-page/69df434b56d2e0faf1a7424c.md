...
Tu variable `initialFetch` debe ser una función.
...
Tu variable `initialFetch` debe ser una función asíncrona.
...
Tu función `initialFetch` debe usar la sintaxis de función flecha.
