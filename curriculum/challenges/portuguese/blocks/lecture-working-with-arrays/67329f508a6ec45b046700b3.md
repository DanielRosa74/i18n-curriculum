...
Outra característica importante dos arrays em JavaScript é que eles são dinâmicos, ou seja, seu tamanho pode mudar depois de criados. Você pode adicionar ou remover elementos de um array usando vários métodos de array, como `push()`, `pop()`, `shift()`, `unshift()`, `splice()` e outros. Esses métodos serão ensinados nas próximas lições.
