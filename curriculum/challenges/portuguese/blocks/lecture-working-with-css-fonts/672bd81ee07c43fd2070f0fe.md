...
Vamos conferir alguns exemplos de fontes web-safe. Em uma lição anterior, você aprendeu que fontes sans-serif são comumente usadas para desenvolvimento web porque não têm pequenos "pés" ou linhas nas extremidades dos caracteres, o que facilita a leitura na tela. Alguns exemplos de fontes sans-serif web-safe são:
