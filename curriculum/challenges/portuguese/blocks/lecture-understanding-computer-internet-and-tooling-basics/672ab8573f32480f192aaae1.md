...
A primeira ferramenta é o próprio computador. Um computador é o ambiente principal de desenvolvimento. Pode ser um desktop pesado ou um laptop portátil com Windows, macOS ou Linux como sistema operacional.
...
IDEs como Visual Studio, IntelliJ IDEA e PyCharm oferecem recursos poderosos como conclusão de código, depuração e suporte a terminal integrado.
...
Outros editores de código são Sublime Text e Notepad++.

Quando você escreve código com editores de código e IDEs, precisa acompanhar as mudanças feitas nesse código. A ferramenta que permite rastrear essas mudanças é um sistema de controle de versão.
