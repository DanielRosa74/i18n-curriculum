...
1. Debes tener un elemento `header`, y debe ser el primer elemento dentro del `body`.
1. Dentro del elemento `header`, debes tener un elemento `h1` que contenga el texto `Event Hub` y un elemento `nav`.
1. Dentro del elemento `nav`, debes tener una lista desordenada de dos elementos que contengan enlaces a diferentes secciones de la página. El primer elemento debe tener el texto `Upcoming Events` y el segundo debe tener el texto `Past Events`.
...
1. Debes tener un elemento `main` que contenga las diferentes secciones de la página.
1. Dentro del elemento `main`, debes tener dos elementos `section`.
1. El primer elemento `section` debe tener un atributo `id` con el valor `upcoming-events`
1. Dentro de la sección `#upcoming-events`, debes tener:
