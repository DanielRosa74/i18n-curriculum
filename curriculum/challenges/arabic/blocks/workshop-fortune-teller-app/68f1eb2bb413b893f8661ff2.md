...
داخل طريقة `newReading`، نفذ استدعاء `showElements` ومرر `this.elements.singleCardBtn` و`this.elements.multipleCardsBtn` و`this.elements.headerTitle` كمعلمات.

ثم نفذ استدعاء `hideElements` ومرر `this.elements.singleCard` و`this.elements.multipleCard` و`this.elements.fortuneContainer` و`this.elements.fortuneDescription` كمعلمات.
