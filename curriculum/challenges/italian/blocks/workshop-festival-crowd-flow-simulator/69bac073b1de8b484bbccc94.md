...
La tua `handleGateAtTick` funzione dovrebbe prima registrare il seguente messaggio nella console: `"\nProcessing " + gate.id + "..."`.
...
La tua `handleGateAtTick` funzione dovrebbe registrare il `id` corretto del gate nel messaggio.
