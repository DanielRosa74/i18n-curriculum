...
A linha de comando é uma interface básica de entrada de texto que permite ao usuário digitar "comandos", geralmente na forma de uma série de caracteres, e enviá-los ou executá-los, normalmente pressionando a tecla <kbd>Enter</kbd>. Você verá interfaces de linha de comando mais comumente dentro de um terminal.
...
A tecla <kbd>Enter</kbd> usada para enviar comandos.
