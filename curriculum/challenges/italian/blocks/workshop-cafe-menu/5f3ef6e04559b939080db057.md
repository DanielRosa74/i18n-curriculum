...
Poiché tutti e quattro i lati del menu hanno la stessa spaziatura interna, rimuovi le quattro proprietà e usa una singola proprietà `padding` con il valore `20px`.
