...
## O que é o atributo `aria-hidden`?
...
## Quando não usar o atributo `aria-hidden`
...
## Evite esconder elementos focáveis
...
## Exemplo: escondendo um ícone decorativo
...
## Quando você não precisa do atributo `aria-hidden`
...
## Valores aninhados do atributo `aria-hidden`
