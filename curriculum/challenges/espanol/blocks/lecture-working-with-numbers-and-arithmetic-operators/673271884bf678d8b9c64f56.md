...
Cuando mezclas diferentes operadores en una sola expresión, el motor de JavaScript sigue un sistema llamado precedencia de operadores para determinar el orden de las operaciones. La precedencia de operadores determina el orden en que se ejecutan las operaciones en las expresiones. Aprenderás más sobre la precedencia de operadores en lecciones futuras.
