...
بالنظر إلى سلسلة نصية لاسم لون في CSS، أنشئ كود لون سداسي عشري (hex) عشوائي يكون اللون السائد فيه هو اللون المعطى.

- يجب أن تتعامل الدالة مع `"red"`، `"green"`، أو `"blue"` كمعلمة مُدخَل.
- إذا لم يكن المُدخَل واحدًا من هذه، يجب أن ترجع الدالة `"Invalid color"`.
- يجب أن ترجع الدالة كود لون سداسي عشري عشوائي مكون من ستة أحرف حيث تكون قيمة اللون المُدخَل أكبر من أي من الألوان الأخرى.
...
يجب أن ترجع الدالة `generate_hex("red")` كود لون سداسي عشري صالح مكون من ستة أحرف.
...
يجب أن ترجع الدالة `generate_hex("red")` لونًا سداسي عشريًا صالحًا بقيمة حمراء أعلى من بقية الألوان.
