...
Usando la misma sintaxis de interpolación, agrega un segundo elemento `p` con el texto `$${expenses} Total Expenses` debajo del elemento `p` existente.

# --hints--

Debes agregar un segundo elemento `p` debajo del existente.
...
Tu segundo elemento `p` debe tener el texto `$${expenses} Total Expenses`.
