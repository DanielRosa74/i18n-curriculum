...
Se você precisa exibir abreviações como acrônimos ou siglas em HTML, o elemento abbreviation é exatamente o que você está procurando. Você deve sempre explicar seu significado completo quando usá-los pela primeira vez. Depois, pode usar o elemento abbreviation para destacá-los e fornecer mais detalhes.
...
A sigla HTML está dentro de um elemento abbreviation. No navegador, você verá que nada realmente mudou. Ainda parece texto normal. O elemento abbreviation está fornecendo um contexto útil nos bastidores, mas os usuários ainda verão a sigla como texto normal.
...
Geralmente, o estilo do elemento abbreviation muda quando você adiciona esse atributo. O estilo específico depende do navegador. Alguns navegadores podem exibir um sublinhado pontilhado, enquanto outros podem converter o conteúdo para pequenas maiúsculas. Quando o usuário passa o mouse sobre a abreviação, a forma completa é exibida como um tooltip.
