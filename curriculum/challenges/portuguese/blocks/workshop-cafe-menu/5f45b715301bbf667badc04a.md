...
O espaço acima do texto do menu `CAMPER CAFE` não corresponde ao espaço abaixo do endereço na parte inferior do menu. Isso ocorre porque o navegador aplica uma margem superior padrão ao `h1` elemento.
