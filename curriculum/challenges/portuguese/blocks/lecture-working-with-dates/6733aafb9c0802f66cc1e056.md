...
## Criando uma data com um valor específico

Aqui está um exemplo de criação de um novo objeto `Date` com uma string de data específica:
...
Isso é útil quando você precisa trabalhar com uma data e hora específicas em vez da data e hora atuais.

## Obtendo a hora atual com `Date.now()`
