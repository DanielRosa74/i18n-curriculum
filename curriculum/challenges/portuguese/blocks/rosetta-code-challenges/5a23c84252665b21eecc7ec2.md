...
\\begin{align}d_j = \\begin{cases}0& & \\text{se }m=0 \\\\\\\\{\\frac {1}{3}}\\left({\\frac {m}{|s\_{1}|}}+{\\frac {m}{|s\_{2}|}}+{\\frac {m-t}{m}}\\right)& & \\text{caso contrário}\\end{cases}\\end{align}

Onde:

<ul>
  <li>\(m\) é o número de <i>caracteres correspondentes</i>;</li>
  <li> \(t\) é metade do número de <i>transposições</i>.</li>
</ul>
