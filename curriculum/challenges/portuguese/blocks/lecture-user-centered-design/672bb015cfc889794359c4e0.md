...
O que é um modal? É o tipo de pop-up que um site pode mostrar para você sobre o seu conteúdo. O HTML tem um elemento `dialog` que você pode usar para criar modais.
