...
Hay algunos elementos HTML que no tienen etiqueta de cierre. Estos elementos suelen verse así: `<br />` o `<img/>`, pero algunos también se pueden usar sin la barra diagonal de cierre, como `<br>` o `<img>`. Estos se conocen como elementos vacíos o elementos nulos porque no contienen ningún contenido. Encontrarás algunos de estos en lecciones posteriores, pero en la mayoría de los casos, los elementos tendrán tanto etiqueta de apertura como etiqueta de cierre.
