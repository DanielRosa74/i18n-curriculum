...
- Tumia mzunguko wa `for` rudia kupitia kila lango katika safu ya data ya `gates` ya ingizo. Kwa kila lango, ongeza sifa kwenye `summary` ambapo:
  - Ufunguo ni `id` ya lango.
  - Thamani ni `0`.
...
Kitendakazi chako cha `initializeThroughput` kinapaswa kurudisha `{}` kinapoitwa na `[]`, bila kubadilisha safu ya data ya ingizo.
...
Kitendakazi chako cha `initializeThroughput` kinapaswa kurudisha `{ North: 0 }` kinapoitwa na `[{ id: "North", capacity: 5, queue: [1, 2, 3] }]`, bila kubadilisha safu ya data ya ingizo.
...
Kitendakazi chako cha `initializeThroughput` kinapaswa kurudisha `{ North: 0, East: 0, South: 0 }` kinapoitwa na `[{ id: "North", capacity: 5, queue: [] }, { id: "East", capacity: 3, queue: [] }, { id: "South", capacity: 4, queue: [] }]`, bila kubadilisha safu ya data ya ingizo.
...
Kitendakazi chako cha `initializeThroughput` kinapaswa kurudisha `summary` baada ya mzunguko, kama mstari wa mwisho katika kitendakazi.
