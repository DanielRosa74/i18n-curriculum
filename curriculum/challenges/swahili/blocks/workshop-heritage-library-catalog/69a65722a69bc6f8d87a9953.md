...
Unapaswa kutangaza kigezo cha `const` kinachoitwa `header` chenye thamani `"Title,Author,Year,Location"`.
...
Unapaswa kutangaza kigezo cha `const` kinachoitwa `rows` kilichowekwa kuwa safu ya data tupu.
