...
Le espressioni regolari possono anche prendere specifici flag per modificare il comportamento del pattern matching. I flag si aggiungono dopo la chiusura `/`. Il flag `g`, che sta per "global", indica al pattern di continuare a cercare anche dopo aver trovato una corrispondenza. Ecco un esempio:
