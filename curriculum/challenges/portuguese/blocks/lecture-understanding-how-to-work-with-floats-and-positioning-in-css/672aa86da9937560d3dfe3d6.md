...
Floats também foram populares para criar layouts multi-coluna antes do Flexbox e da grade se tornarem amplamente usados. Ao flutuar elementos lado a lado, os desenvolvedores podiam criar colunas alinhadas horizontalmente. No entanto, ao usar floats, é importante lidar com o problema do colapso dos elementos pai quando seus elementos filho estão flutuando. A técnica clearfix é aplicada ao elemento com a classe `container` para resolver esse problema.
