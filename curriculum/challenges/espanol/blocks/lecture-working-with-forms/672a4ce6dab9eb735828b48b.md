...
Un ejemplo común de validación integrada en formularios es usar el atributo `required` en las entradas. El atributo `required` especifica que el usuario debe completar esa parte del formulario antes de que se envíe. Aquí tienes un ejemplo de cómo usar el atributo `required` en una entrada de correo electrónico.
...
Los nombres de estos atributos sugieren para qué se usan.
