...
Um grande detalhe é que todo o código dos componentes de servidor permanece no servidor e não é enviado para o navegador. Isso significa que você não pode usar React hooks com eles, e eles não têm acesso às Web APIs ou aos ouvintes de eventos do navegador. Então, como adicionar interatividade?
