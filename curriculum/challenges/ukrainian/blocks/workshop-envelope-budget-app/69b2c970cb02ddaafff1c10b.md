...
Усередині вашого шаблонного рядка створіть `label` елемент і надайте йому текст `Expense # Name`. Використовуючи синтаксис шаблонного рядка, замініть `#` на значення `entryNumber`.
