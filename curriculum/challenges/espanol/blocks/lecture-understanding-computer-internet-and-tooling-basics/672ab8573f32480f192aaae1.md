...
La primera herramienta es la computadora misma. Una computadora es el entorno principal de desarrollo. Puede ser una estación de trabajo pesada o una laptop portátil con Windows, macOS o Linux como sistema operativo.
...
Los IDEs como Visual Studio, IntelliJ IDEA y PyCharm ofrecen funcionalidades potentes como la finalización de código, la depuración y soporte integrado para terminal.
...
Otros editores de código son Sublime Text y Notepad++.

Cuando escribes código con editores de código e IDEs, necesitas rastrear los cambios que haces en ese código. La herramienta que te permite rastrear esos cambios es un sistema de control de versiones.
