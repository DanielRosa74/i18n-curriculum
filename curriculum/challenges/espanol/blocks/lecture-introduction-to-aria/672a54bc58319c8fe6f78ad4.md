...
## ¿Qué es el atributo `aria-hidden`?
...
## Cuándo no usar el atributo `aria-hidden`
...
## Evita ocultar elementos que pueden recibir foco
...
## Ejemplo: ocultar un icono decorativo
...
## Cuándo no necesitas el atributo `aria-hidden`
...
## Valores anidados del atributo `aria-hidden`
