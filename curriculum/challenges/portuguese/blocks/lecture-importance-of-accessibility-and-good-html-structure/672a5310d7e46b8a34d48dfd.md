...
macOS e iOS têm o VoiceOver embutido. Você pode habilitá-lo no seu computador pressionando <kbd>CMD</kbd> + <kbd>F5</kbd>. No iPhone, você pode acessá-lo pelas Configurações.

Computadores Windows têm o Narrator embutido. Você pode ativá-lo pressionando <kbd>WIN</kbd> + <kbd>CTRL</kbd> + <kbd>ENTER</kbd>. O NonVisual Desktop Access (NVDA) e o Job Access With Speech (JAWS) também estão disponíveis para Windows. O NVDA é gratuito e de código aberto, enquanto o JAWS é pago.
