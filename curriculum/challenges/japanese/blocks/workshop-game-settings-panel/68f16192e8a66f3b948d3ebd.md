...
疑似クラスセレクターと疑似要素セレクターが `input[type="checkbox"]:checked::after` の結合型セレクターに `font-weight` プロパティを追加してください。
...
疑似クラスセレクターと疑似要素セレクターが `input[type="checkbox"]:checked::after` の結合型セレクターに `color` プロパティを追加してください。
...
疑似クラスセレクターと疑似要素セレクターが `input[type="checkbox"]:checked::after` の結合型セレクターに `line-height` プロパティを追加してください。
