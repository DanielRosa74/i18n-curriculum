...
Quando um usuário visita um site, o servidor pode enviar um ou mais cookies para o navegador do usuário incluindo um cabeçalho Set-Cookie na resposta HTTP. Um cabeçalho é um par chave-valor que fornece informações adicionais sobre a requisição ou resposta HTTP. Você vai aprender mais sobre requisições e respostas HTTP em lições futuras.
