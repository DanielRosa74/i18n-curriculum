...
**Nota** Consideraciones de privacidad: Debido al requisito de que solo se debe aceptar 1 like por IP, tendrás que guardar las direcciones IP. Es importante cumplir con las leyes de privacidad de datos como el Reglamento General de Protección de Datos. Una opción es obtener permiso para guardar los datos del usuario, pero es mucho más sencillo anonimizarlo. Para este desafío, recuerda anonimizar las direcciones IP antes de guardarlas en la base de datos. Si necesitas ideas sobre cómo hacerlo, puedes optar por hashear los datos, truncarlos o poner parte de la dirección IP en 0.
