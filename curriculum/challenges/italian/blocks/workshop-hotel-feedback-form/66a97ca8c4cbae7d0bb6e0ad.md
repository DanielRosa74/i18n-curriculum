...
Dovresti avere un elemento `option` con il `value` impostato su `"poor"`.
...
Dovresti avere un elemento `option` con il `value` impostato su `"very-good"`.
...
Dovresti avere un elemento `option` con il `value` impostato su `"excellent"`.
...
Il tuo elemento `option` con il `value` di `"excellent"` dovrebbe avere l'attributo `selected`.
