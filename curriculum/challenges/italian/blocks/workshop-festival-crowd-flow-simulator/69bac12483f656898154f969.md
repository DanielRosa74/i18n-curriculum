...
Dovresti iterare attraverso ogni proprietà nell'oggetto `summary` e registrare il seguente messaggio una volta per ogni proprietà: `gate + ": " + summary[gate] + " attendees processed"`.
