...
Las lecciones anteriores te presentaron `console.log()`, pero esta lección profundizará en su propósito y uso.
...
Se usa comúnmente para verificar el rendimiento de una aplicación y ver los resultados en la consola.
