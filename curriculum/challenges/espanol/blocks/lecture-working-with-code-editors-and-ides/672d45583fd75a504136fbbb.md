...
Para instalar VS Code, debes visitar el sitio web de VS Code para obtener el instalador adecuado para tu sistema operativo. Asegúrate de visitar el sitio web de VS Code, y no el de Visual Studio.

Para Windows, puedes descargar un instalador EXE. Una vez que lo hayas descargado, ejecuta el archivo y el asistente de instalación te guiará durante el proceso.

Para Mac, puedes descargar un archivo `.zip`, que contiene un `.app` que puedes ejecutar. También puedes instalar VS Code mediante Homebrew.
