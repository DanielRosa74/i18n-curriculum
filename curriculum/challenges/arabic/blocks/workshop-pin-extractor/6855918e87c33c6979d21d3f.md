...
الآن الدالة تقوم بعمل جيد في استخراج الكود من القصيدة، لكن هناك حالة خاصة يجب أخذها في الاعتبار: قد يكون سطر القصيدة أقصر من المتوقع، وهذا سيجعل الدالة ترجع خطأ (يمكنك تجربة ذلك بحذف كلمة `bright` من القصيدة).
