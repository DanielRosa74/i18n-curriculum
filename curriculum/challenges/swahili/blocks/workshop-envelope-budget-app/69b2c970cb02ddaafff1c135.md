...
Kutumia sintaksia ile ile ya uingizaji wa thamani, ongeza kipengele cha pili cha `p` chenye maandishi `$${expenses} Total Expenses` chini ya kipengele cha sasa cha `p`.

# --hints--

Unapaswa kuongeza kipengele cha pili cha `p` chini ya kile kilichopo.
...
Kipengele chako cha pili cha `p` kinapaswa kuwa na maandishi `$${expenses} Total Expenses`.
