...
يحتوي محرر الكود على مكوِّن JSX بسيط. استخدم الطريقة `ReactDOM.render()` لعرض هذا المكوِّن على الصفحة. يمكنك تمرير عناصر JSX المعرفة مباشرةً كالمعلمة الأولى واستخدام `document.getElementById()` لاختيار عقدة DOM التي تريد عرض المكوِّن عليها. يوجد عنصر `div` بمعرف `id='challenge-node'` متاح للاستخدام. تأكد من عدم تغيير الثابت `JSX`.
