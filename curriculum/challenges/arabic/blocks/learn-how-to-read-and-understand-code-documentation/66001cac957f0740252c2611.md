...
تُظهر كيفية ضبط الخيارات بشكل صحيح والتأثير الذي تحدثه على الكود.

---

تقدم تاريخًا لكيفية تطوير الكود.

### --feedback--

تؤكد سارة على التطبيق العملي، موضحة كيفية استخدام المعلمات وتأثيراتها، بدلاً من مناقشة التطور التاريخي للكود.

---

تدرج جميع الأخطاء المحتملة في الكود.
...
تقدم طرقًا بديلة لكتابة نفس الكود.
