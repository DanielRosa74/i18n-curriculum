...
Antes de começarmos, você deve saber o que é uma regra at em CSS. Regras at são declarações que fornecem instruções para o navegador. Você pode usá-las para definir vários aspectos da folha de estilos, como consultas de mídia, keyframes, faces de fonte e mais. Você vai aprender mais sobre conceitos como consultas de mídia e keyframes em lições futuras. Desta vez, você vai aprender sobre a regra at `@font-face`.
