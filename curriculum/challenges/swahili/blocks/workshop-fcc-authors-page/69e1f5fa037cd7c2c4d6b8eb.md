...
`catch` yako haipaswi tena kuwa njia iliyounganishwa.

```js
assert.notMatch(code, /\.catch/);
```

Kipande chako cha `try` kinapaswa kuwa na taarifa tatu zinazopata data, kuunda `json`, na kisha kuonyesha.
...
Ukurasa wako wa Waandishi wa fCC unapaswa kuonyesha kwa usahihi.
