...
Aqui está um exemplo de tentativa de mudar o primeiro caractere de uma string, o que gera um erro:
...
Para mudar o valor, você atribui uma string inteira nova à variável `developer`:
