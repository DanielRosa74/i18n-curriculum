...
Versuchen Sie, ein paar Einträge zur Kategorie `Food` hinzuzufügen, und Sie werden möglicherweise einige Bugs bemerken! Das Erste, was wir beheben müssen, sind die Eintragszahlen – der erste Eintrag sollte eine Zahl von `1` haben, nicht `0`.
