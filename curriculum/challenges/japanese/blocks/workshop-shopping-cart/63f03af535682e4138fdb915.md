...
`totalNumberOfItems` 要素の `textContent` を `0` に設定し、`cartSubTotal`、`cartTaxes`、および `cartTotal` 要素の `textContent` を `"$0"` に設定してください。
...
`cartSubTotal` 要素の `textContent` を `"$0"` に設定してください。
...
`cartTaxes` 要素の `textContent` を `"$0"` に設定してください。
...
`cartTotal` 要素の `textContent` を `"$0"` に設定してください。
