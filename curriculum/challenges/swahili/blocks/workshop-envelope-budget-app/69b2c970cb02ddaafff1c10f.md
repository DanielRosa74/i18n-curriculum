...
Mwishowe, kwenye mstari mpya baada ya `label` yako ya pili, tengeneza kipengele kingine cha `input`. Mpe sifa ya kipengele `type` iliyowekwa kuwa `number`, sifa ya kipengele `min` iliyowekwa kuwa `0` (ili kuhakikisha kiasi hasi hakiwezi kuongezwa), sifa ya kipengele `placeholder` iliyowekwa kuwa `Amount`, na sifa ya kipengele `id` inayolingana na sifa ya kipengele `for` ya kipengele chako cha pili cha `label`.
...
Kipengele chako cha `input` kinapaswa kuwa na sifa ya kipengele `placeholder` iliyowekwa kuwa `Amount`.
...
Kipengele chako cha `input` kinapaswa kuwa na sifa ya kipengele `id` iliyowekwa kuwa `${category}-${entryNumber}-amount`.
...
Kipengele chako kipya cha `input` kinapaswa kuwa na sifa ya kipengele `min` iliyowekwa kuwa `0`.
