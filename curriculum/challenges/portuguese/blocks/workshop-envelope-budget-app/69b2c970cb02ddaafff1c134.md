...
Agora crie um elemento `p` com o texto `$${income} Total Income`, usando interpolação para substituir income pela variável apropriada.
...
Seu elemento `p` deve ter o texto `$${income} Total Income`.
