...
텍스트가 `Book Inventory`인 `h1` 요소가 있어야 합니다.
...
`status` 클래스를 가진 `span` 요소와 `span`으로 시작하는 클래스 값을 가진 `rate` 요소를 대상으로 하는 속성 선택자를 사용하여 `height` 속성을 설정해야 합니다.
...
`status` 클래스를 가진 `span` 요소와 `span`으로 시작하는 클래스 값을 가진 `rate` 요소를 대상으로 하는 속성 선택자를 사용하여 `width` 속성을 설정해야 합니다.
...
`status` 클래스를 가진 `span` 요소와 `span`으로 시작하는 클래스 값을 가진 `rate` 요소를 대상으로 하는 속성 선택자를 사용하여 `padding` 속성을 설정해야 합니다.
