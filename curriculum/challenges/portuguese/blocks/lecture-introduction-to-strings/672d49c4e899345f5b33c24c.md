...
As lições anteriores apresentaram `console.log()`, mas esta lição vai se aprofundar no propósito e uso dele.
...
Ele é comumente usado para verificar o desempenho de uma aplicação e ver os resultados no console.
