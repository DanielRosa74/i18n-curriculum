...
Всередині кожного з трьох нових `li` елементів створіть `a` елемент з атрибутом `href`, значення якого — `#`.

# --hints--

Ви маєте створити новий `a` елемент з атрибутом `href`, значення якого — `#`, всередині кожного з трьох нових `li` елементів.
