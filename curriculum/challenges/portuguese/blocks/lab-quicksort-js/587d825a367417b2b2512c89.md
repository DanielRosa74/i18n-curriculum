...
Quicksort é um método de ordenação muito eficiente, oferecendo desempenho *O(nlog(n))* na média. Também é relativamente fácil de implementar. Essas características fazem dele um método de ordenação popular e útil.
