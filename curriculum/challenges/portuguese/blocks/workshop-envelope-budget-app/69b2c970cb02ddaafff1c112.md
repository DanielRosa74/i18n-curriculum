...
Tente adicionar algumas entradas na categoria `Food` e você pode notar alguns bugs! A primeira coisa que precisamos corrigir são as contagens das entradas – a primeira entrada deve ter uma contagem de `1`, não `0`.
