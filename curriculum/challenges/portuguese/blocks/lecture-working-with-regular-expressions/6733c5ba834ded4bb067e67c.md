...
Assim como com um padrão simples, você também pode criar uma expressão regular com flags usando o construtor `RegExp`. O construtor aceita as flags como um segundo argumento opcional:
...
Isso é equivalente a escrever `/freeCodeCamp/gi` diretamente. Vamos confirmar que eles se comportam da mesma forma:
...
Veja como o âncora de início só corresponde ao começo da string, e o âncora de fim só corresponde ao final da string? Mas e quanto a corresponder em várias linhas? Vamos dar uma olhada nisso:
