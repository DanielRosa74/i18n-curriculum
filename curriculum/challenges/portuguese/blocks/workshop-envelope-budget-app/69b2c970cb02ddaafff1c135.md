...
Usando a mesma sintaxe de interpolação, adicione um segundo elemento `p` com o texto `$${expenses} Total Expenses` abaixo do elemento `p` existente.

# --hints--

Você deve adicionar um segundo elemento `p` abaixo do existente.
...
Seu segundo elemento `p` deve ter o texto `$${expenses} Total Expenses`.
