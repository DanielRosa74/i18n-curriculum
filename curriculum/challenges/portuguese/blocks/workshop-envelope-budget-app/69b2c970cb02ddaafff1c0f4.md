...
Regex também pode receber flags específicas para alterar o comportamento da correspondência do padrão. As flags são adicionadas após a barra de fechamento `/`. A flag `g`, que significa "global", fará com que o padrão continue procurando depois de encontrar uma correspondência. Aqui está um exemplo:
