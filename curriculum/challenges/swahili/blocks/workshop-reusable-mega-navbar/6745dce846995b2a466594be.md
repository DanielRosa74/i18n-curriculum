...
Tengeneza vipengele vipya vitatu vya `li` ndani ya kipengele chako cha `ul` chenye `className` ya `sub-menu`.

# --hints--

Unapaswa kutengeneza vipengele vipya vitatu vya `li` ndani ya kipengele chako cha `ul` chenye `className` ya `sub-menu`.
