...
عدّل الدالة بحيث تُرجع مصفوفة من السلاسل النصية التي تحتوي على كود HTML لعرض بطاقات الآلات، بحيث تمثل كل سلسلة نصية كائنًا في مصفوفة `instruments`. يجب أن تكون السلاسل النصية بهذا الشكل `<div class="card"><h2>[instrument]</h2><p>$[price]</p></div>`
