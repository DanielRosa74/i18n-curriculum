...
- **Posicionamiento sticky**: Este tipo de posicionamiento actúa como un híbrido entre el posicionamiento relativo y el fijo. Inicialmente, el elemento se comporta como si estuviera posicionado de forma relativa, permaneciendo dentro del flujo del documento. Sin embargo, una vez que el usuario desplaza el elemento más allá de cierto punto, este se "pega" al viewport (generalmente en la parte superior) y se comporta como si estuviera fijo. Esto es ideal para crear elementos como barras de navegación sticky, que solo se fijan cuando el usuario se desplaza hasta una posición determinada.
