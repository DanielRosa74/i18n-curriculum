...
El borde es el borde exterior o esquema de un elemento en el modelo de caja CSS. Es el límite visual del elemento. Puedes personalizar el estilo, el ancho, el color y otras propiedades del borde usando la propiedad `border`. Aquí tienes un ejemplo donde establecemos el borde con un ancho de cinco píxeles, el estilo sólido y un color azul:
...
Puedes escribir hasta cuatro valores para cada una de estas propiedades. Se aplicarán en una secuencia en el sentido de las agujas del reloj comenzando desde la parte superior. Si solo escribes un valor, se aplicará a los cuatro lados.
