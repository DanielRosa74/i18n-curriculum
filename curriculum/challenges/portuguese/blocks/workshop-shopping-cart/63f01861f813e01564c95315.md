...
Dentro do seu `div`, adicione dois elementos `p`. Defina o texto do segundo elemento `p` para ser um cifrão seguido do valor da variável `price`.
...
Seu segundo elemento `p` deve ter um cifrão seguido do valor da variável `price`.
