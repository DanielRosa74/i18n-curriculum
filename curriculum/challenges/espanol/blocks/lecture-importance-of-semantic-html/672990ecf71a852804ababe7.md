...
## Elementos HTML presentacionales
...
Y a continuación, tenemos el elemento `big`. Este es otro elemento HTML presentacional obsoleto que hace que el texto encerrado sea un nivel más grande que el texto que lo rodea. Aquí tenemos un ejemplo que define un párrafo con dos partes.
