...
As propriedades padrão de um elemento `hr` farão com que ele apareça como uma linha fina cinza clara. Você pode alterar a altura da linha especificando um valor para a propriedade `height`.
