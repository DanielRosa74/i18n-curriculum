...
Semântica é o significado das palavras ou frases em uma língua. No HTML, que é uma linguagem, os elementos também têm seu próprio significado semântico. Na verdade, você pode pensar no seu documento HTML como pensaria em um documento de texto. E, assim como em um documento de texto, você pode ter títulos, imagens, texto em negrito e outras formatações.
