...
Nesta lição, vamos abordar alguns dos mais usados com PostgreSQL. Os tipos de dados variam entre os sistemas de gerenciamento de banco de dados, mas geralmente são bem parecidos. Então, você precisará consultar a lista completa na documentação.
