...
React é uma das bibliotecas JavaScript mais populares para construir interfaces de usuário e aplicações web. Originalmente desenvolvida no Facebook, agora Meta, React ganhou enorme popularidade no desenvolvimento web devido à sua eficiência, flexibilidade e recursos.

Um conceito fundamental em React é a criação de componentes de interface reutilizáveis. Esses componentes, como botões, cartões e avatares, podem ser facilmente reutilizados em toda a sua aplicação. Você pode aninhar esses componentes uns dentro dos outros para construir interfaces mais complexas e dinâmicas.
...
Embora existam muitas bibliotecas dentro do ecossistema JavaScript, o freeCodeCamp ensina principalmente React por causa do seu uso amplo e demanda na indústria.

Nas próximas lições, você vai se aprofundar na construção de componentes personalizados, no gerenciamento de estado e muito mais.
...
Revise a seção sobre gerenciamento de estado na sua aplicação.
