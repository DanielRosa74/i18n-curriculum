...
Ihre `handleGateAtTick`-Funktion sollte zuerst die folgende Nachricht in der Konsole ausgeben: `"\nProcessing " + gate.id + "..."`.
...
Ihre `handleGateAtTick`-Funktion sollte die korrekte Tor-`id` in der Nachricht ausgeben.
