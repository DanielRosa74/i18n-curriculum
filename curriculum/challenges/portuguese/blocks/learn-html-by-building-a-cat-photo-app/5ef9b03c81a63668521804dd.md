...
O texto ` Indoor` deve estar localizado diretamente à direita do seu botão `radio`. Certifique-se de que há um espaço entre o elemento e o texto. Você ou omitiu o texto ou cometeu um erro de digitação.
