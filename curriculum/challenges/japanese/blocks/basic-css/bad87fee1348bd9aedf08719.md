...
テキストが`I am red!`の`h1`要素には`color`の赤を指定してください。
...
テキストが`I am green!`の`h1`要素には`color`の緑を指定してください。
...
テキストが`I am cyan!`の`h1`要素には`color`のシアンを指定してください。
...
テキストが`I am fuchsia!`の`h1`要素には`color`のフクシアを指定してください。
