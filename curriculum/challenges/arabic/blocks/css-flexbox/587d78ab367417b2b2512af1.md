...
على اليمين يوجد تضمين التغريدة الذي سيُستخدم كمثال عملي. بعض العناصر ستبدو أفضل بتخطيط مختلف. التحدي الأخير بيّن `display: flex`. هنا ستضيفه إلى عدة مكوِّنات في تضمين التغريدة لتبدأ بضبط مواضعها.
