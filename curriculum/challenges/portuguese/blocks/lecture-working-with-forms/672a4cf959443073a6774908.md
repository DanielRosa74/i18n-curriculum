...
Quando o usuário clica em um controle de formulário ou o seleciona com a tecla <kbd>Tab</kbd> do teclado, isso significa que ele está no estado `focused`. Quando uma entrada está no estado `focused`, a maioria dos navegadores mostra uma borda azul destacada ao redor da entrada. Mas você pode escolher adicionar estilos adicionais em CSS.

Clique em qualquer parte do espaço em branco na janela de visualização e depois pressione a tecla <kbd>Tab</kbd> para ver o estado de foco. Para ver as prévias, será necessário habilitar o editor interativo.
...
Outro tipo de estado de formulário é o estado `readonly`. Esse é quando um controle de formulário, como uma entrada, não pode ser editado pelo usuário. Aqui está um exemplo de como definir uma entrada de e-mail como somente leitura. O atributo `value` é usado para definir o valor exibido dentro do campo de entrada.
...
Quando o usuário clica em uma entrada ou a seleciona usando a tecla <kbd>Tab</kbd> para focá-la.
