...
첫 번째 `p` 요소 안의 `h2` 요소 아래에 텍스트 `Red`를 가진 `.box` 요소를 추가하세요.
...
두 번째 `p` 요소 안의 `h2` 요소 아래에 텍스트 `Orange`를 가진 `.box` 요소를 추가하세요.
...
세 번째 `p` 요소 안의 `h2` 요소 아래에 텍스트 `Yellow`를 가진 `.box` 요소를 추가하세요.
...
네 번째 `p` 요소 안의 `h2` 요소 아래에 텍스트 `Green`를 가진 `.box` 요소를 추가하세요.
...
다섯 번째 `p` 요소 안의 `h2` 요소 아래에 텍스트 `Blue`를 가진 `.box` 요소를 추가하세요.
...
여섯 번째 `p` 요소 안의 `h2` 요소 아래에 텍스트 `Indigo`를 가진 `.box` 요소를 추가하세요.
