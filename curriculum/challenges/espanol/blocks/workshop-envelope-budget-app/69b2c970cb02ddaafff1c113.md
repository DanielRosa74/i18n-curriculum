...
Tu otro bug ocurre si agregas una entrada `Food`, la completas y luego agregas una segunda entrada `Food`. Verás que los valores que agregaste desaparecieron.
