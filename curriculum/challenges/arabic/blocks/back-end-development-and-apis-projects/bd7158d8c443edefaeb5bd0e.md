...
ابنِ تطبيق JavaScript متكامل الوظائف يشبه هذا: <a href="https://url-shortener-microservice.freecodecamp.rocks" target="_blank" rel="noopener noreferrer nofollow">https://url-shortener-microservice.freecodecamp.rocks</a>. يتطلب العمل على هذا المشروع كتابة الكود باستخدام إحدى الطرق التالية:
