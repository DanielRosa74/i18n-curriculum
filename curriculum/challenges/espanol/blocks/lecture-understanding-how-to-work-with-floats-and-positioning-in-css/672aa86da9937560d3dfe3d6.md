...
Los floats también fueron populares para crear diseños multicolumna antes de que Flexbox y Grid se generalizaran. Al flotar elementos uno junto a otro, los desarrolladores podían crear columnas que se alineaban horizontalmente. Sin embargo, al usar floats, es importante manejar el problema del colapso de los elementos padre cuando sus elementos hijo están flotando. La solución con la técnica clearfix se aplica al elemento con la clase `container` para solucionar este problema.
