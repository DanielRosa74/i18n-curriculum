...
يمكن لتعبير نمطي أن يأخذ أيضًا أعلامًا محددة لتغيير سلوك مطابقة النمط. تُضاف الأعلام بعد إغلاق `/`. علم `g`، الذي يعني "عالمي"، يخبر النمط بالاستمرار في البحث بعد أن يجد تطابقًا. إليك مثالًا:
