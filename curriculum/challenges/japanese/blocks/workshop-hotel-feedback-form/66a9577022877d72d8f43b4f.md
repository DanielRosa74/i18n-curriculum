...
`fieldset`要素の中に、テキスト`Why did you choose to stay at our hotel? (Check all that apply)`を持つ`legend`要素を追加してください。

# --hints--

3つ目の`fieldset`要素が必要です。
...
`legend`要素には`Why did you choose to stay at our hotel? (Check all that apply)`というテキストを入れてください。スペルミスやスペースの問題がないか再確認してください。
