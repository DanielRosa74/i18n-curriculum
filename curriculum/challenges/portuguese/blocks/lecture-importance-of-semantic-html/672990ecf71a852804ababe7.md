...
## Elementos de HTML apresentacional
...
E a seguir, temos o elemento `big`. Este é outro elemento HTML apresentacional obsoleto que aumenta o texto contido em um nível a mais que o texto ao redor. Aqui temos um exemplo que define um parágrafo com duas partes.
