...
Usar props no React torna seus componentes mais flexíveis e reutilizáveis, permitindo que você construa interfaces mais complexas. No entanto, é importante notar que props são imutáveis, ou seja, não podem ser alteradas depois de passadas para um componente. Se você precisar lidar com entrada do usuário e modificar dados, deve usar estado em vez disso. Você aprenderá mais sobre como gerenciar estado em lições futuras.
