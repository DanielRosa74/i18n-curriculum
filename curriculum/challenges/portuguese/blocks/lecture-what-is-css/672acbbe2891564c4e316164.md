...
Depois vem uma vírgula seguida de um seletor de `class` que tem como alvo todos os elementos HTML com o valor de `class` igual a `subheading`. Todos os seletores de classe devem começar com um ponto (`.`).
