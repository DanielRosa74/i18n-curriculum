...
Seu outro bug acontece se você adicionar uma entrada `Food`, preenchê-la e depois adicionar uma segunda entrada `Food`. Você verá que os valores que adicionou desapareceram.
