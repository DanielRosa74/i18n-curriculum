...
Em uma lição anterior, você aprendeu como usar HTML para restringir os valores que seus usuários podem enviar no seu formulário. Mas às vezes isso não é suficiente. Se quiser algo mais complexo, como mostrar suas próprias mensagens de erro para o usuário, será necessário usar JavaScript.
...
## Configurando o formulário com validação HTML
...
## Restringindo a entrada com o atributo `pattern`
...
## Verificando a validade com `checkValidity()`
...
## Reportando a validade com `reportValidity()`
...
## Definindo uma mensagem personalizada com `setCustomValidity()`
...
## Explorando a propriedade `validity`
