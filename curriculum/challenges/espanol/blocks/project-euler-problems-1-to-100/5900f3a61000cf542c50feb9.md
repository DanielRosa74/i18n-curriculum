...
Comenzando con 1 y formando una espiral en sentido contrario a las agujas del reloj de la siguiente manera, se crea una espiral cuadrada con una longitud de lado de 7.
