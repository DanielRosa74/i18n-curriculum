...
Sasa tengeneza kipengele cha `p` chenye maandishi `$${income} Total Income`, ukitumia uingizaji wa thamani kubadilisha income na kigezo kinachofaa.
...
Kipengele chako cha `p` kinapaswa kuwa na maandishi `$${income} Total Income`.
