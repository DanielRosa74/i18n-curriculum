...
Rimuovi i tre componenti `<Card />` all'interno dell'elemento `<div className="flex-container">`. Nei prossimi passaggi, creerai un array di dati e userai il metodo `map()` per renderizzare i componenti `Card`, che è l'approccio più comune in React.
