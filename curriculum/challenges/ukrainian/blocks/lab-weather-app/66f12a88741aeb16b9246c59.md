...
Окрім порожнього першого варіанту, елемент `select` повинен містити 6 елементів `option`, по одному для кожного з наступних міст: Париж, Лондон, Токіо, Лос-Анджелес, Чикаго, Нью-Йорк.
