...
O segundo é quando o usuário pressiona a tecla <kbd>Enter</kbd> em qualquer campo de entrada editável no formulário.
...
Pressionar <kbd>Enter</kbd> em um campo de entrada editável.
