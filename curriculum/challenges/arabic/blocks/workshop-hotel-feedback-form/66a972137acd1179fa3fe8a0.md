...
يجب أن يكون لديك عنصر `option` بقيمة `value` مضبوطة على `"poor"`.
...
يجب أن يكون لديك عنصر `option` بقيمة `value` مضبوطة على `"very-good"`.
...
يجب أن يكون لديك عنصر `option` بقيمة `value` مضبوطة على `"excellent"`.
