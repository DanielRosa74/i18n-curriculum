...
Números de ponto flutuante são números com casas decimais. Desenvolvedores JavaScript frequentemente os chamam apenas de "floats". Floats são úteis quando você precisa de mais precisão, como ao lidar com medidas ou moedas. Aqui estão alguns exemplos:
