...
Quando l'utente inserisce gli importi di entrate o spese, i campi di input accetteranno solo valori numerici. Tuttavia, se un numero viene inserito con un segno `+` o `-`, dovrai rimuovere quei caratteri.
