...
تحتاج أيضًا إلى الحصول على قيمة المُدخَل `#income`. لقد استعلمت عنها بالفعل في بداية شفرتك، وعينتها إلى المتغير `incomeInput`. مع ذلك، استخدمت `getElementById`، التي تُرجع `Element`، وليس `NodeList`.
