...
يجب ألا تحتوي كودك على سطر إنشاء `email_obj`.
...
يجب ألا تحتوي كودك على `print(email_obj.sender)`.
...
يجب ألا تحتوي كودك على `print(email_obj.subject)`.
...
يجب ألا تحتوي كودك على `print(email_obj.read)`.
...
يجب ألا تحتوي كودك على `email_obj.mark_as_read()`.
