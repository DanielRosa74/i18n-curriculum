...
In Regex erlauben Kurzzeichenklassen, bestimmte Zeichen zu finden, ohne diese Zeichen explizit im Muster schreiben zu müssen.

Kurzzeichenklassen werden mit einem Backslash (`\`) eingeleitet. Die Zeichenklasse `\s` findet jedes Leerzeichen. Fügen Sie dies ans Ende Ihres Regex-Musters an.
