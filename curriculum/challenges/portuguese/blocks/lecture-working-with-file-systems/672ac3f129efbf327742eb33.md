...
Vá para suas configurações, filtre por "Control Center", clique nessa opção e depois role para baixo até encontrar a opção "Spotlight". Você também pode usar um atalho de teclado para abrir o Spotlight: <kbd>Command</kbd> + <kbd>Spacebar</kbd>.
...
Outra forma de buscar arquivos que você abriu recentemente é abrir o Finder clicando no ícone do Finder no Dock. Depois, vá para "Recentes" na barra lateral do Finder. Lá, você encontrará todos os arquivos que visualizou recentemente.
