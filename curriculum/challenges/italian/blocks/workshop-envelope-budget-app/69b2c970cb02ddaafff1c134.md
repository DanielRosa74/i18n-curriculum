...
Ora crea un elemento `p` con il testo `$${income} Total Income`, usando l'interpolazione per sostituire income con la variabile appropriata.
...
Il tuo elemento `p` dovrebbe avere il testo `$${income} Total Income`.
