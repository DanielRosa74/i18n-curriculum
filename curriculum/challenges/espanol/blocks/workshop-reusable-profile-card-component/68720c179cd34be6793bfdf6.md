...
Elimina los tres componentes `<Card />` dentro del elemento `<div className="flex-container">`. En los próximos pasos, crearás un arreglo de datos y usarás el método `map()` para renderizar los componentes `Card`, que es el enfoque más común en React.
