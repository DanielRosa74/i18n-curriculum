...
En JavaScript, todos los operadores aritméticos tienen una forma de asignación compuesta. Los operadores de asignación compuesta ofrecen una forma abreviada y concisa para realizar una operación sobre una variable y luego almacenar el resultado en esa misma variable. Combinan la operación y la asignación en una forma más corta como `x += y`, que es equivalente a escribir `x = x + y` pero sin repetir el nombre de la variable. En lugar de escribir algo así:
