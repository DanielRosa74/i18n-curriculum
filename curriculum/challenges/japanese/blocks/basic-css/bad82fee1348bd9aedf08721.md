...
テキストが`I am red!`の`h1`要素は`color`の赤色にしてください。
...
テキストが`I am orchid!`の`h1`要素は`color`のオーキッド色にしてください。
...
テキストが`I am blue!`の`h1`要素は`color`の青色にしてください。
...
テキストが`I am sienna!`の`h1`要素は`color`のシエナ色にしてください。
