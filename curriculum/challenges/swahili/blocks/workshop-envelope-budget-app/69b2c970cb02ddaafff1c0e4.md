...
Unahitaji seti moja zaidi ya sehemu za msimbo za `fieldset` kwa ajili ya `entertainment`.
...
Kipengele chako cha nne cha `fieldset` kinapaswa kuwa na `id` iliyowekwa kuwa `entertainment`.
...
Kipengele chako cha nne cha `legend` kinapaswa kuwa na maandishi `Entertainment`.
