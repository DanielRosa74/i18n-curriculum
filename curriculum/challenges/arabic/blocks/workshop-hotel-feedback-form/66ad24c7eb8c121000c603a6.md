...
لجعل مربع اختيار `input` محددًا افتراضيًا، يمكنك إضافة الخاصية `checked`.
...
أضف الخاصية `checked` إلى مربع اختيار `input` الذي يحمل الخاصية `id` بقيمة `"reputation"` ليكون محددًا افتراضيًا.

# --hints--

يجب أن يحتوي مربع اختيار `input` الخاص بك الذي يحمل الخاصية `id` بقيمة `"reputation"` على الخاصية `checked`.
