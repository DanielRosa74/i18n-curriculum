...
Sin embargo, los elementos en línea no comienzan en una nueva línea. Aparecen en la misma línea que los elementos junto a los que se colocan. Un claro ejemplo de un elemento en línea es un enlace, o etiqueta `<a>`. Si colocas uno de estos en medio de un párrafo de texto, se comportará como parte del párrafo. <a href="https://www.freecodecamp.org/" target="_blank">(Como este)</a> El texto del enlace se ubicará junto a otras palabras en ese párrafo. Además, el padding y el margen se comportan de manera diferente en los elementos en línea. En general, no quieres intentar agregar padding o margen extra a los elementos en línea.
