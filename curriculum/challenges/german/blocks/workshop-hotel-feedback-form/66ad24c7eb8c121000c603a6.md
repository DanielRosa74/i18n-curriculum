...
Um ein Kontrollkästchen-`input` standardmäßig aktiviert zu machen, können Sie das `checked`-Attribut hinzufügen.
...
Fügen Sie dem Kontrollkästchen-`input` mit der `id` `"reputation"` das `checked`-Attribut hinzu, damit es standardmäßig aktiviert ist.

# --hints--

Ihr Kontrollkästchen-`input` mit der `id` `"reputation"` sollte das `checked`-Attribut haben.
