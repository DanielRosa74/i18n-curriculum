...
يشير إلى مشكلة أو خطأ برمجي في الكود يحتاج إلى معالجة.
...
هذا المصطلح يصف مجموعة من الكود تؤدي مهمة محددة ويمكن إعادة استخدامها في جميع أنحاء البرنامج.
...
يصف متتالية في الكود تتكرر إما عددًا محددًا من المرات أو حتى يتغير شرط معين.
