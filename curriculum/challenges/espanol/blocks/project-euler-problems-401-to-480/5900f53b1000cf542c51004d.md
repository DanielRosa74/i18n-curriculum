...
Encuentra $F({10}^{18})$. Da tu respuesta como una cadena en notación científica redondeada a diez dígitos después del punto decimal. Al dar tu respuesta, usa una `e` minúscula para separar la mantisa y el exponente. Por ejemplo, si la respuesta es $112\\,233\\,445\\,566\\,778\\,899$, el formato de la respuesta sería `1.1223344557e17`.
