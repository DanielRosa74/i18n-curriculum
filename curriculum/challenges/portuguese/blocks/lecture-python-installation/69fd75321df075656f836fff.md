...
Abra um app de terminal, digite `python` e pressione <kbd>Enter</kbd>. Isso vai iniciar um shell interativo do Python. Um shell interativo é um programa que permite digitar comandos um de cada vez e ver os resultados.
...
Se quiser sair do shell interativo, você pode digitar `exit()` ou pressionar <kbd>Ctrl</kbd> + <kbd>D</kbd> no Mac/Linux ou <kbd>Ctrl</kbd> + <kbd>Z</kbd> + <kbd>Enter</kbd> no Windows.
