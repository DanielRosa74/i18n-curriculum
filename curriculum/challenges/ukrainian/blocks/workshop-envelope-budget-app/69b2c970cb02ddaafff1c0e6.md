...
У вашому `span` елементі створіть `label` елемент з атрибутом `for`, встановленим на `entry-dropdown`, і додайте йому текст `Add expense to:`. Потім створіть `select` елемент з `id`, встановленим на `entry-dropdown`, і `name`, встановленим на `options`. Нижче додайте `button` елемент з `id`, встановленим на `add-entry`, і текстом `Add Entry`.
...
Ваш новий `label` елемент повинен містити текст `Add expense to:`.
...
Ваш новий `button` елемент повинен мати атрибут `type`, встановлений на `button`.
