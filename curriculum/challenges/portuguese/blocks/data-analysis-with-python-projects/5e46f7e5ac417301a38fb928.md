...
Você estará <a href="https://codespaces.new/freeCodeCamp/boilerplate-mean-variance-standard-deviation-calculator/" target="_blank" rel="noopener noreferrer nofollow">trabalhando neste projeto com nosso código inicial</a>.
...
Escreva seu código em `mean_var_std.py`. Para desenvolvimento, você pode usar `main.py` para testar seu código.
Para executar seu código, digite `python3 main.py` no terminal e pressione enter. Isso fará o interpretador CPython incluído executar o arquivo `main.py`.
