...
У вас має бути `option` елемент зі `value`, встановленим у `"poor"`.
...
У вас має бути `option` елемент зі `value`, встановленим у `"very-good"`.
...
У вас має бути `option` елемент зі `value`, встановленим у `"excellent"`.
