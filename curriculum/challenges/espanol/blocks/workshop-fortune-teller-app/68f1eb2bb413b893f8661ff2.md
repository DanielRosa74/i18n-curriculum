...
Dentro del método `newReading`, llama a `showElements` y pasa `this.elements.singleCardBtn`, `this.elements.multipleCardsBtn` y `this.elements.headerTitle` como argumentos.

Luego llama a `hideElements` y pasa `this.elements.singleCard`, `this.elements.multipleCard`, `this.elements.fortuneContainer` y `this.elements.fortuneDescription` como argumentos.
